...
goog.provide('Blockly.Blocks.devToolbox');

goog.require('Blockly.Blocks');

const noBlocks = '<label text="No blocks" web-class="extensionLabel"></label>';

var motion = '<category name="Motion" colour="#CCCCCC" secondaryColour="#999999" disabled="true">'+
    noBlocks + 
    '</category>'
;

var looks = '<category name="Looks" colour="#CCCCCC" secondaryColour="#999999" disabled="true">'+
    noBlocks + 
    '</category>'
;

var sound = '<category name="Sound" colour="#CCCCCC" secondaryColour="#999999" disabled="true">'+
    noBlocks + 
    '</category>'
;

var pen = '<category name="Pen" colour="#CCCCCC" secondaryColour="#999999" disabled="true">'+
    noBlocks + 
    '</category>'
;

var data = '<category name="Data" colour="#FF8C1A" secondaryColour="#DB6E00" custom="VARIABLE">' +
  '</category>'
;

var events = '<category name="Events" colour="#CCCCCC" secondaryColour="#999999" disabled="true">'+
    noBlocks + 
    '</category>'
;

var control = '<category name="Control" colour="#FFAB19" secondaryColour="#CF8B17">'+
...
var sensing = '<category name="Sensing" colour="#CCCCCC" secondaryColour="#999999" disabled="true">'+
    noBlocks + 
    '</category>'
;

var operators = '<category name="Operators" colour="#CCCCCC" secondaryColour="#999999" disabled="true">'+
    noBlocks + 
    '</category>'
;

var dev = '<category name="Dev" colour="#40BF4A" secondaryColour="#389438">'+
    '<block type="dev_ledon" id="dev_ledon">'+
      '<value name="PORT">'+
        '<shadow type="dev_port_menu"></shadow>'+
      '</value>'+
    '</block>'+
    '<block type="dev_ledoff" id="dev_ledoff">'+
      '<value name="PORT">'+
        '<shadow type="dev_port_menu"></shadow>'+
      '</value>'+
    '</block>'+
    '<block type="dev_tspressed" id="dev_tspressed">'+
      '<value name="PORT">'+
        '<shadow type="dev_port_menu"></shadow>'+
      '</value>'+
    '</block>'+
    '<block type="dev_sonar" id="dev_sonar">'+
      '<value name="PORT">'+
        '<shadow type="dev_port_menu"></shadow>'+
      '</value>'+
    '</block>'+
    '<block type="dev_arduinoMain" id="dev_arduinoMain">'+
    '</block>'+
  '</category>'
;

Blockly.Blocks.devToolbox = '<xml id="toolbox-categories" style="display: none">' + 
    motion + 
    looks +
    sound + 
    pen + 
...
'<xml id="toolbox-categories" style="display: none">'+
  '<category name="Motion" colour="#4C97FF" secondaryColour="#3373CC" disabled="true">'+
  ...
  '<category name="Operators" colour="#40BF4A" secondaryColour="#389438">'+
    ...
    '</block>'+
  '</category>'+
  '<category name="Dev" colour="#40BF4A" secondaryColour="#389438">'+
    '<block type="dev_ledon" id="dev_ledon">'+
      '<value name="PORT">'+
        '<shadow type="dev_port_menu"></shadow>'+
      '</value>'+
