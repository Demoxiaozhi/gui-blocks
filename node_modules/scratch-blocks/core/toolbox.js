...
Blockly.Toolbox.prototype.showAll_ = function() {
  var allContents = [];
  // TODO: Remove below 3 lines when scratch-gui#10 resolved!
  var category = this.categoryMenu_.categories_[0];
  this.showAllForCategory_(category);
  return;
...
/**
 * TODO: Remove below function when scratch-gui#10 resolved!
 * Show all blocks for one category in the flyout
 * @private
 */
Blockly.Toolbox.prototype.showAllForCategory_ = function(item) {
    var allContents = [];
    var category = item;
...
Blockly.Toolbox.prototype.getHeight = function() {
  return this.categoryMenu_ ? this.categoryMenu_.getHeight() + 3 : 0;   // TODO: 为何增加3px? (如果不增加，切换语言的时候，category会出现滚动条！！）
};
...
Blockly.Toolbox.prototype.refreshSelection = function() {
  // TODO: Remove below 8 lines when scratch-gui#10 resolved!
  // TODO: it is invoked 4 times when switch gui from costumes tab to blocks tab???!!!
  var item = this.getSelectedItem();
  if (item) {
    this.showAllForCategory_(item);
  } else {
    this.showAll_();
  }
  return;
...
Blockly.Toolbox.prototype.selectCategoryByName = function(name) {
  // TODO: Remove below line when scratch-gui#10 resolved!
  return;
  for (var i = 0; i < this.categoryMenu_.categories_.length; i++) {
    var category = this.categoryMenu_.categories_[i];
