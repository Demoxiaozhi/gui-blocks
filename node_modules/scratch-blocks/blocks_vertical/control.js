...
Blockly.Blocks['control_if_else'] = {
  ...
  init: function() {
    this.jsonInit({
      ...
      "message0": Blockly.Msg.CONTROL_IF_ELSE,
      "message1": "%1",
      "message2": Blockly.Msg.CONTROL_IF_ELSE_ELSE,
      "message3": "%1",
      "args0": [
        {
          "type": "input_value",
...
Blockly.Blocks['control_stop'] = {
  ...
  init: function() {
    ...
    var stopDropdown = new Blockly.FieldDropdown(function() {
      ...
      return [[Blockly.Msg.CONTROL_STOPMENUALL, ALL_SCRIPTS],
        [Blockly.Msg.CONTROL_STOPMENUTHIS, THIS_SCRIPT],
        [Blockly.Msg.CONTROL_STOPMENUOTHER, OTHER_SCRIPTS]
      ];
    }, function(option) {
...
Blockly.Blocks['control_repeat_until'] = {
  ...
  init: function() {
    this.jsonInit({
      "message0": Blockly.Msg.CONTROL_REPEAT_UNTIL,
      "message1": "%1",
      "message2": "%1",
      "lastDummyAlign2": "RIGHT",
      "args0": [
...
Blockly.Blocks['control_start_as_clone'] = {
  ...
  init: function() {
    this.jsonInit({
      ...
      "message0": Blockly.Msg.CONTROL_START_AS_CLONE,
      "args0": [
      ],
      "category": Blockly.Categories.control,
        ...
        "args0": [
          {
            ...
            "name": "CLONE_OPTION",
            "options": [
              [Blockly.Msg.CONTROL_CREATE_CLONE_OF_MYSELF, '_myself_']
            ]
          }
        ],
...
Blockly.Blocks['control_create_clone_of'] = {
  ...
  init: function() {
    this.jsonInit({
      "id": "control_start_as_clone",
      "message0": Blockly.Msg.CONTROL_CREATE_CLONE_OF,
      "args0": [
        {
          "type": "input_value",
          "name": "CLONE_OPTION"
...
Blockly.Blocks['control_delete_this_clone'] = {
  ...
  init: function() {
    this.jsonInit({
      "message0": Blockly.Msg.CONTROL_DELETE_THIS_CLONE,
      "args0": [
      ],
      "category": Blockly.Categories.control,
      "extensions": ["colours_control", "shape_end"]
