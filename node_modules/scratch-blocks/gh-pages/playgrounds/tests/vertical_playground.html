...
<html>
  <head>
    ...
    <!-- <script src="../msg/js/en.js" id="LANG"></script> -->
    ...
    <script src="../blocks_vertical/dev.js"></script>
    <script src="../blocks_vertical/default_toolbox.js"></script>

    <script src="../blocks_vertical/dev_toolbox.js"></script>
    <script src="../generators/arduino.js"></script>
    
    <script src="../generators/arduino/shadow_types.js"></script>
    <script src="../generators/arduino/control.js"></script>
    <script src="../generators/arduino/dev.js"></script>
    ...
    function refreshWorkspace() {
        ...
        // 说明: options会经过options.js文件进行处理，读取出来的options和传递进去不一致，需要注意还原！！！
        options.media = options.pathToMedia;
        options.zoom = options.zoomOptions;
        options.grid = options.gridOptions;
    ...
    // change language
    function updateLanguage(langName, onFinished) {
        var id = 'blockly-lang';
        var langNode = document.getElementById(id),
        src = '../msg/js/' + langName + '.js';

        if (langNode) {
            document.head.removeChild(langNode);
        }

        // create new node
        langNode = document.createElement('script');
        langNode.id = id;
        langNode.onload = function () {
            // console.log("new lang loaded..");
            // new lang loaded
            refreshWorkspace();

            var toolbox = Blockly.Blocks.getDefaultToolbox();
            workspace.updateToolbox(toolbox);
            if (onFinished) onFinished();   // Note: toolbox should be updated seperately!!! specially handled using workspace.updateToolbox
        };
        document.head.appendChild(langNode);
        langNode.src = src;
    }
  ...
  <body onload="start()">
    ...
    <script>
        function realTimeGenerateArduino(workspace) {
    ...
    <input type="button" value="UpdateToolBox" onclick="workspace.updateToolbox(Blockly.Blocks.devToolbox)" />
    <input type="button" value="To Arduino" onclick="toCode('Arduino')">
    <input type="button" value="Auto-Generate Arduino" onclick="realTimeGenerateArduino(workspace)">
