...
!!a.rtl,m=a.horizontalLayout;void 0===m&&(m=!1);var n=a.toolboxPosition;n="end"===n?!1:!0;var p=m?n?Blockly.TOOLBOX_AT_TOP:Blockly.TOOLBOX_AT_BOTTOM:n==l?Blockly.TOOLBOX_AT_RIGHT:Blockly.TOOLBOX_AT_LEFT;var q=a.scrollbars;void 0===q&&(q=f);var r=a.css;void 0===r&&(r=!0);var v="https://blockly-demo.appspot.com/static/media/";a.media?v=a.media:a.path&&(v=a.path+"media/");n=void 0===a.oneBasedIndex?!0:!!a.oneBasedIndex;var w=!!a.realtime,x=w?a.realtimeOptions:void 0,t=a.colours;if(t)for(var u in t)t.hasOwnProperty(u)&&
Blockly.Colours.hasOwnProperty(u)&&(Blockly.Colours[u]=t[u]);this.RTL=l;this.oneBasedIndex=n;this.collapse=d;this.comments=c;this.disable=b;this.readOnly=g;this.pathToMedia=v;this.hasCategories=f;this.hasScrollbars=q;this.hasTrashcan=e;this.hasSounds=k;this.hasCss=r;this.horizontalLayout=m;this.languageTree=h;this.gridOptions=Blockly.Options.parseGridOptions_(a);this.zoomOptions=Blockly.Options.parseZoomOptions_(a);this.enableRealtime=w;this.realtimeOptions=x;this.toolboxPosition=p};
...
Blockly.BlockSvg.DEFINE_BLOCK_PADDING_RIGHT=2*Blockly.BlockSvg.GRID_UNIT;Blockly.BlockSvg.DEFINE_BLOCK_TYPE="procedures_defnoreturn";
Blockly.BlockSvg.prototype.updateColour=function(){var a=this.getColourTertiary();var b=this.isShadow()&&!Blockly.utils.isShadowArgumentReporter(this);b&&this.parentBlock_&&(a=this.parentBlock_.getColourTertiary(),this.inputList[0]&&this.inputList[0].fieldRow[0]&&(this.inputList[0].fieldRow[0]instanceof Blockly.FieldColour||this.inputList[0].fieldRow[0]instanceof Blockly.FieldColourSlider)&&(a=Blockly.Colours.colourPickerStroke));this.svgPath_.setAttribute("stroke",a);a=this.isGlowingBlock_||b?this.getColourSecondary():
this.getColour();this.svgPath_.setAttribute("fill",a);this.svgPath_.setAttribute("fill-opacity",this.getOpacity());for(var c in this.inputShapes_)this.inputShapes_[c].setAttribute("fill",this.getColourTertiary());c=this.getIcons();for(a=0;a<c.length;a++)c[a].updateColour();for(c=0;a=this.inputList[c];c++)for(var b=0,d;d=a.fieldRow[b];b++)d.setText(null)};
...
Blockly.BlockSvg.prototype.highlightShapeForInput=function(a,b){a=this.getInputWithConnection(a);if(!a)throw"No input found for the connection";a=this.inputShapes_[a.name];b?(a.setAttribute("filter","url(#blocklyReplacementGlowFilter)"),Blockly.utils.addClass(this.svgGroup_,"blocklyReplaceable")):(a.removeAttribute("filter"),Blockly.utils.removeClass(this.svgGroup_,"blocklyReplaceable"))};
...
Blockly.BlockSvg.prototype.render=function(a){Blockly.Field.startCache();this.rendered=!0;var b=Blockly.BlockSvg.SEP_SPACE_X;this.RTL&&(b=-b);for(var c=this.getIcons(),d=0;d<c.length;d++)b=c[d].renderIcon(b);b+=this.RTL?Blockly.BlockSvg.SEP_SPACE_X:-Blockly.BlockSvg.SEP_SPACE_X;c=this.renderCompute_(b);this.renderDraw_(b,c);this.renderMoveConnections_();this.renderClassify_();!1!==a&&((a=this.getParent())?a.render(!0):Blockly.resizeSvgContents(this.workspace));Blockly.Field.stopCache()};
Blockly.BlockSvg.prototype.renderFields_=function(a,b,c){this.RTL&&(b=-b);for(var d=0,e;e=a[d];d++){var f=e.getSvgRoot();if(f){!this.previousConnection||e instanceof Blockly.FieldLabel||e instanceof Blockly.FieldImage||(b=this.RTL?Math.min(b,-Blockly.BlockSvg.INPUT_AND_FIELD_MIN_X):Math.max(b,Blockly.BlockSvg.INPUT_AND_FIELD_MIN_X));var g=-e.getSize().height/2,h="";if(this.RTL){var k=b-=e.renderSep+e.renderWidth;g=c+g;e.renderWidth&&(b-=Blockly.BlockSvg.SEP_SPACE_X)}else k=b+e.renderSep,g=c+g,e.renderWidth&&
(b+=e.renderSep+e.renderWidth+Blockly.BlockSvg.SEP_SPACE_X);this.RTL&&e instanceof Blockly.FieldImage&&e.getFlipRTL()&&(h="scale(-1 1)",k+=e.renderWidth);f.setAttribute("transform","translate("+k+", "+g+") "+h);this.isInsertionMarker()&&f.setAttribute("display","none")}}return this.RTL?-b:b};
Blockly.BlockSvg.prototype.renderCompute_=function(a){var b,c=this.inputList,d=[];d.rightEdge=0;for(var e=d.bottomEdge=0,f=!1,g=!1,h=!1,k=void 0,l=0,m;m=c[l];l++)if(m.isVisible()){if(k&&k!=Blockly.NEXT_STATEMENT&&m.type!=Blockly.NEXT_STATEMENT)var n=d[d.length-1];else k=m.type,n=this.createRowForInput_(m),d.push(n);n.push(m);m.renderHeight=this.computeInputHeight_(m,n,b);m.renderWidth=this.computeInputWidth_(m);n.statementNotchAtBottom=!0;m.connection&&m.connection.type===Blockly.NEXT_STATEMENT&&
(b=m.connection.targetBlock())&&!b.lastConnectionInStack()&&(n.statementNotchAtBottom=!1);if(m.connection){b=m.connection.targetBlock();var p=0;b?(p=b.getHeightWidth(),b=p.height,p=p.width):b=Blockly.BlockSvg.INPUT_SHAPE_HEIGHT;m.connection.type===Blockly.INPUT_VALUE&&(b+=2*Blockly.BlockSvg.INLINE_PADDING_Y);m.connection.type===Blockly.NEXT_STATEMENT&&n.statementNotchAtBottom&&(b-=Blockly.BlockSvg.NOTCH_HEIGHT);m.renderHeight=Math.max(m.renderHeight,b);m.renderWidth=Math.max(m.renderWidth,p)}n.height=
Math.max(n.height,m.renderHeight);m.fieldWidth=0;1==d.length&&(m.fieldWidth+=this.RTL?-a:a);b=!1;for(var p=0,q;q=m.fieldRow[p];p++){0!=p&&(m.fieldWidth+=Blockly.BlockSvg.SEP_SPACE_X);var r=q.getSize();q.renderWidth=r.width;q.renderSep=b&&q.EDITABLE?Blockly.BlockSvg.SEP_SPACE_X:0;m.fieldWidth+=q.renderWidth+q.renderSep;n.height=Math.max(n.height,r.height);b=q.EDITABLE}n.type!=Blockly.BlockSvg.INLINE&&(n.type==Blockly.NEXT_STATEMENT?(g=!0,e=Math.max(e,m.fieldWidth)):n.type==Blockly.INPUT_VALUE?f=!0:
n.type==Blockly.DUMMY_INPUT&&(h=!0));b=n}this.computeOutputPadding_(d);d.statementEdge=Blockly.BlockSvg.STATEMENT_INPUT_EDGE_WIDTH+e;d.rightEdge=this.computeRightEdge_(d.rightEdge,g);for(l=0;l<d.length;l++)d.bottomEdge+=d[l].height;d.hasValue=f;d.hasStatement=g;d.hasDummy=h;return d};
...
Blockly.BlockSvg.prototype.createRowForInput_=function(a){var b=[];b.type=a.type!=Blockly.NEXT_STATEMENT?Blockly.BlockSvg.INLINE:a.type;b.height=0;b.paddingStart=Blockly.BlockSvg.SEP_SPACE_X;b.paddingEnd=Blockly.BlockSvg.SEP_SPACE_X;return b};
Blockly.BlockSvg.prototype.computeRightEdge_=function(a,b){this.previousConnection||this.nextConnection?a=Math.max(a,Blockly.BlockSvg.MIN_BLOCK_X):this.outputConnection&&(a=this.isShadow()&&!Blockly.utils.isShadowArgumentReporter(this)?Math.max(a,Blockly.BlockSvg.MIN_BLOCK_X_SHADOW_OUTPUT):Math.max(a,Blockly.BlockSvg.MIN_BLOCK_X_OUTPUT));b&&(a=Math.max(a,Blockly.BlockSvg.MIN_BLOCK_X_WITH_STATEMENT));0<this.insertionMarkerMinWidth_&&(a=Math.max(a,this.insertionMarkerMinWidth_));return a};
Blockly.BlockSvg.prototype.computeOutputPadding_=function(a){if(this.getOutputShape()&&this.outputConnection&&(!this.isShadow()||Blockly.utils.isShadowArgumentReporter(this))&&!(1<a.length)){a=a[0];var b=this.getOutputShape();a.paddingStart=0;a.paddingEnd=0;var c=a[0];if(c.fieldRow[0])var d=0;else d=c.connection,d=d.targetConnection?d.targetConnection.getSourceBlock().getOutputShape():d.getOutputShape(),b==Blockly.OUTPUT_SHAPE_HEXAGONAL&&d!=Blockly.OUTPUT_SHAPE_HEXAGONAL&&(c=c.renderHeight-Blockly.BlockSvg.MIN_BLOCK_Y_REPORTER,
a.paddingStart+=c/2);a.paddingStart+=Blockly.BlockSvg.SHAPE_IN_SHAPE_PADDING[b][d];c=a[a.length-1];c.connection?(d=c.connection,d=d.targetConnection?d.targetConnection.getSourceBlock().getOutputShape():d.getOutputShape(),b==Blockly.OUTPUT_SHAPE_HEXAGONAL&&d!=Blockly.OUTPUT_SHAPE_HEXAGONAL&&(c=c.renderHeight-Blockly.BlockSvg.MIN_BLOCK_Y_REPORTER,a.paddingEnd+=c/2)):d=0;a.paddingEnd+=Blockly.BlockSvg.SHAPE_IN_SHAPE_PADDING[b][d]}};
...
Blockly.BlockSvg.prototype.renderDrawTop_=function(a,b){this.type==Blockly.BlockSvg.DEFINE_BLOCK_TYPE?(a.push("m 0, 0"),a.push(Blockly.BlockSvg.TOP_LEFT_CORNER_DEFINE_HAT)):(this.squareTopLeftCorner_?(a.push("m 0,0"),this.startHat_&&a.push(Blockly.BlockSvg.START_HAT_PATH),this.edgeShapeWidth_&&a.push("m "+this.edgeShapeWidth_+",0")):(a.push(Blockly.BlockSvg.TOP_LEFT_CORNER_START),a.push(Blockly.BlockSvg.TOP_LEFT_CORNER)),this.previousConnection&&(a.push("H",Blockly.BlockSvg.NOTCH_START_PADDING),a.push(Blockly.BlockSvg.NOTCH_PATH_LEFT),
this.previousConnection.setOffsetInBlock(this.RTL?-Blockly.BlockSvg.NOTCH_WIDTH:Blockly.BlockSvg.NOTCH_WIDTH,0)));this.width=b};
Blockly.BlockSvg.prototype.renderDrawRight_=function(a,b,c){for(var d,e,f,g=0,h,k=0,l;l=b[k];k++){e=l.paddingStart;0==k&&(e+=this.RTL?-c:c);if(l.type==Blockly.BlockSvg.INLINE){for(var m=0;f=l[m];m++)if(d=g+l.height/2,e=Blockly.BlockSvg.getAlignedCursor_(e,f,b.rightEdge),e=this.renderFields_(f.fieldRow,e,d),f.type==Blockly.INPUT_VALUE){this.previousConnection&&(e=Math.max(e,Blockly.BlockSvg.INPUT_AND_FIELD_MIN_X));d=this.RTL?-e:e;var n=l.height/2;h=g+n;f.connection.setOffsetInBlock(d,h);this.renderInputShape_(f,
e,g+n);e+=f.renderWidth+Blockly.BlockSvg.SEP_SPACE_X}e-=Blockly.BlockSvg.SEP_SPACE_X;e+=l.paddingEnd;b.rightEdge=Math.max(e,b.rightEdge);e=Math.max(e,b.rightEdge);this.width=Math.max(this.width,e);this.edgeShape_?a.push("H",e-this.edgeShapeWidth_):(a.push("H",e-Blockly.BlockSvg.CORNER_RADIUS-this.edgeShapeWidth_),a.push(Blockly.BlockSvg.TOP_RIGHT_CORNER));this.edgeShape_||a.push("v",l.height-2*Blockly.BlockSvg.CORNER_RADIUS)}else l.type==Blockly.NEXT_STATEMENT&&(f=l[0],d=g,d+=Blockly.BlockSvg.MIN_STATEMENT_INPUT_HEIGHT,
this.renderFields_(f.fieldRow,e,d),e=b.statementEdge+Blockly.BlockSvg.NOTCH_WIDTH,this.type==Blockly.BlockSvg.DEFINE_BLOCK_TYPE?this.renderDefineBlock_(a,b,f,l):Blockly.BlockSvg.drawStatementInputFromTopRight_(a,e,b.rightEdge,l),d=this.RTL?-e:e,f.connection.setOffsetInBlock(d,g),f.connection.isConnected()&&(this.width=Math.max(this.width,b.statementEdge+f.connection.targetBlock().getHeightWidth().width)),this.type==Blockly.BlockSvg.DEFINE_BLOCK_TYPE||k!=b.length-1&&b[k+1].type!=Blockly.NEXT_STATEMENT||
(a.push(Blockly.BlockSvg.TOP_RIGHT_CORNER),a.push("v",Blockly.BlockSvg.EXTRA_STATEMENT_ROW_Y-2*Blockly.BlockSvg.CORNER_RADIUS),g+=Blockly.BlockSvg.EXTRA_STATEMENT_ROW_Y));g+=l.height}this.drawEdgeShapeRight_(a);b.length||(g=Blockly.BlockSvg.MIN_BLOCK_Y,a.push("V",g));return g};
Blockly.BlockSvg.prototype.renderInputShape_=function(a,b,c){var d=this.inputShapes_[a.name];d&&(a.connection.targetConnection?d.setAttribute("style","visibility: hidden"):(a=Blockly.BlockSvg.getInputShapeInfo_(a.connection.getOutputShape()),b=this.RTL?-b-a.width:b,c-=Blockly.BlockSvg.INPUT_SHAPE_HEIGHT/2,d.setAttribute("d",a.path),d.setAttribute("transform","translate("+b+","+c+")"),d.setAttribute("data-argument-type",a.argType),d.setAttribute("style","visibility: visible")))};
