...
Blockly.Blocks.getDefaultToolbox = function() {
    return '<xml id="toolbox-categories" style="display: none">'+
  '<category name="' + Blockly.Msg.CATEGORY_MOTION + '" colour="#4C97FF" secondaryColour="#3373CC">'+
...
Blockly.Blocks.defaultToolbox = Blockly.Blocks.getDefaultToolbox();
