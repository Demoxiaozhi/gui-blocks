...
/***/ function(module, exports, __webpack_require__) {
	...
	var goog = __webpack_require__(9);
	...
	/// block: looks, switchcostumeto
	Blockly.Msg.LOOKS_SWITCHCOSTUMETO = 'switch costume to %1';
	/// block: looks, nextcostume
	Blockly.Msg.LOOKS_NEXTCOSTUME = 'next costume';
	/// block: looks, nextbackdrop
	Blockly.Msg.LOOKS_NEXTBACKDROP = 'next backdrop';
	/// block: looks, switchbackdropto
	Blockly.Msg.LOOKS_SWITCHBACKDROPTO = 'switch backdrop to %1';
	/// block: looks, switchbackdroptoandwait
	Blockly.Msg.LOOKS_SWITCHBACKDROPTOWAIT = 'switch backdrop to %1 and wait';
	/// block: looks, changeeffectby
	Blockly.Msg.LOOKS_CHANGEEFFECTBY = 'change %1 effect by %2';
	/// block: looks, seteffectto
	Blockly.Msg.LOOKS_SETEFFECTTO = 'set %1 effect to %2';
	/// block: looks, cleargraphiceffects
	Blockly.Msg.LOOKS_CLEARGRAPHICEFFECTS = 'clear graphic effects';
	/// block: looks, changesizeby
	Blockly.Msg.LOOKS_CHANGESIZEBY = 'change size by %1';
	/// block: looks, setsizeto
	Blockly.Msg.LOOKS_SETSIZETO = 'set size to %1 %';
	/// block: looks, gotofront
	Blockly.Msg.LOOKS_GOTOFRONT = 'go to front';
	/// block: looks, gobacklayers
	Blockly.Msg.LOOKS_GOBACKLAYERS = 'go back %1 layers';
	/// block: looks, costumeorder
	Blockly.Msg.LOOKS_COSTUMEORDER = 'costume #';
	/// block: looks, backdroporder
	Blockly.Msg.LOOKS_BACKDROPORDER = 'backdrop #';
	/// block: looks, backdropname
	Blockly.Msg.LOOKS_BACKDROPNAME = 'backdrop name';
	/// block: looks, size
	Blockly.Msg.LOOKS_SIZE = 'size';
	/// block: looks, effect_menu_options
	Blockly.Msg.LOOKS_EFFECTMENUCOLOR = 'color';
	/// block: looks, effect_menu_options
	Blockly.Msg.LOOKS_EFFECTMENUFISHEYE = 'fisheye';
	/// block: looks, effect_menu_options
	Blockly.Msg.LOOKS_EFFECTMENUWHIRL = 'whirl';
	/// block: looks, effect_menu_options
	Blockly.Msg.LOOKS_EFFECTMENUPIXELATE = 'pixelate';
	/// block: looks, effect_menu_options
	Blockly.Msg.LOOKS_EFFECTMENUMOSAIC = 'mosaic';
	/// block: looks, effect_menu_options
	Blockly.Msg.LOOKS_EFFECTMENUBRIGHTNESS = 'brightness';
	/// block: looks, effect_menu_options
	Blockly.Msg.LOOKS_EFFECTMENUGHOST = 'ghost';
	/// block: looks, sayforsecs
	Blockly.Msg.LOOKS_SAYFORSECS = 'say %1 for %2 secs';
	/// block: looks, say
	Blockly.Msg.LOOKS_SAY = 'say %1';
	/// block: looks, thinkforsecs
	Blockly.Msg.LOOKS_THINKFORSECS = 'think %1 for %2 secs';
	/// block: looks, think
	Blockly.Msg.LOOKS_THINK = 'think %1';

	/// category: pen
	Blockly.Msg.CATEGORY_PEN = 'Pen';
	/// block: pen, clear
	...
	/// block: pen, setpencolortocolor
	Blockly.Msg.PEN_SETPENCOLORTOCOLOR = 'set pen color to %1';
	/// block: pen, changepencolorby
	Blockly.Msg.PEN_CHANGEPENCOLORBY = 'change pen color by %1';
	/// block: pen, setpencolortonum
	Blockly.Msg.PEN_SETPENCOLORTONUM = 'set pen color to %1';
	/// block: pen, changepenshadeby
	Blockly.Msg.PEN_CHANGEPENSHADEBY = 'change pen shade by %1';
	/// block: pen, setpenshadeto
	Blockly.Msg.PEN_SETPENSHADETO = 'set pen shade to %1';
	/// block: pen, changepensizeby
	Blockly.Msg.PEN_CHANGEPENSIZEBY = 'change pen size by %1';
	/// block: pen, setpensizeto
	Blockly.Msg.PEN_SETPENSIZETO = 'set pen size to %1';
	/// block: pen, changepentransparencyby
	Blockly.Msg.PEN_CHANGEPENTRANSPARENCYBY = 'change pen transparency by %1';
	/// block: pen, setpentransparencyto
	Blockly.Msg.PEN_SETPENTRANSPARENCYTO = 'set pen transparency to %1';

	/// category: sound
	Blockly.Msg.CATEGORY_SOUND = 'Sound';
	/// block: sound, play
	Blockly.Msg.SOUND_PLAY = 'start sound %1';
	/// block: sound, playuntildone
	Blockly.Msg.SOUND_PLAYUNTILDONE = 'play sound %1 until done';
	/// block: sound, stopallsounds
	Blockly.Msg.SOUND_STOPALLSOUNDS = 'stop all sounds';
	/// block: sound, playdrumforbeats
	Blockly.Msg.SOUND_PLAYDRUMFORBEATS = 'play drum %1 for %2 beats';
	/// block: sound, restforbeats
	Blockly.Msg.SOUND_RESTFORBEATS = 'rest for %1 beats';
	/// block: sound, playnoteforbeats
	Blockly.Msg.SOUND_PLAYNOTEFORBEATS = 'play note %1 for %2 beats';
	/// block: sound, setinstrumentto
	Blockly.Msg.SOUND_SETINSTRUMENTTO = 'set instrument to %1';
	/// block: sound, changeeffectby
	Blockly.Msg.SOUND_CHANGEEFFECTBY = 'change %1 effect by %2';
	/// block: sound, seteffectto
	Blockly.Msg.SOUND_SETEFFECTTO = 'set %1 effect to %2';
	/// block: sound, cleareffects
	Blockly.Msg.SOUND_CLEAREFFECTS = 'clear sound effects';
	/// block: sound, changevolumeby
	Blockly.Msg.SOUND_CHANGEVOLUMEBY = 'change volume by %1';
	/// block: sound, setvolumeto
	Blockly.Msg.SOUND_SETVOLUMETO = 'set volume to %1%';
	/// block: sound, volume
	Blockly.Msg.SOUND_VOLUME = 'volume';
	/// block: sound, changetempoby
	Blockly.Msg.SOUND_CHANGETEMPOBY = 'change tempo by %1';
	/// block: sound, settempotobpm
	Blockly.Msg.SOUND_SETTEMPOTOBPM = 'set tempo to %1 bpm';
	/// block: sound, tempo
	Blockly.Msg.SOUND_TEMPO = 'tempo';
	/// block: sound, drums_menu
	Blockly.Msg.SOUND_DRUMSMENU01 = '(1) Snare Drum';
	/// block: sound, drums_menu
	Blockly.Msg.SOUND_DRUMSMENU02 = '(2) Bass Drum';
	/// block: sound, drums_menu
	Blockly.Msg.SOUND_DRUMSMENU03 = '(3) Side Stick';
	/// block: sound, drums_menu
	Blockly.Msg.SOUND_DRUMSMENU04 = '(4) Crash Cymbal';
	/// block: sound, drums_menu
	Blockly.Msg.SOUND_DRUMSMENU05 = '(5) Open Hi-Hat';
	/// block: sound, drums_menu
	Blockly.Msg.SOUND_DRUMSMENU06 = '(6) Closed Hi-Hat';
	/// block: sound, drums_menu
	Blockly.Msg.SOUND_DRUMSMENU07 = '(7) Tambourine';
	/// block: sound, drums_menu
	Blockly.Msg.SOUND_DRUMSMENU08 = '(8) Hand Clap';
	/// block: sound, drums_menu
	Blockly.Msg.SOUND_DRUMSMENU09 = '(9) Claves';
	/// block: sound, drums_menu
	Blockly.Msg.SOUND_DRUMSMENU10 = '(10) Wood Block';
	/// block: sound, drums_menu
	Blockly.Msg.SOUND_DRUMSMENU11 = '(11) Cowbell';
	/// block: sound, drums_menu
	Blockly.Msg.SOUND_DRUMSMENU12 = '(12) Triangle';
	/// block: sound, drums_menu
	Blockly.Msg.SOUND_DRUMSMENU13 = '(13) Bongo';
	/// block: sound, drums_menu
	Blockly.Msg.SOUND_DRUMSMENU14 = '(14) Conga';
	/// block: sound, drums_menu
	Blockly.Msg.SOUND_DRUMSMENU15 = '(15) Cabasa';
	/// block: sound, drums_menu
	Blockly.Msg.SOUND_DRUMSMENU16 = '(16) Guiro';
	/// block: sound, drums_menu
	Blockly.Msg.SOUND_DRUMSMENU17 = '(17) Vibraslap';
	/// block: sound, drums_menu
	Blockly.Msg.SOUND_DRUMSMENU18 = '(18) Open Cuica';
	/// block: sound, instruments_menu
	Blockly.Msg.SOUND_INSTRUMENTSMENU01 = '(1) Piano';
	/// block: sound, instruments_menu
	Blockly.Msg.SOUND_INSTRUMENTSMENU02 = '(2) Electric Piano';
	/// block: sound, instruments_menu
	Blockly.Msg.SOUND_INSTRUMENTSMENU03 = '(3) Organ';
	/// block: sound, instruments_menu
	Blockly.Msg.SOUND_INSTRUMENTSMENU04 = '(4) Guitar';
	/// block: sound, instruments_menu
	Blockly.Msg.SOUND_INSTRUMENTSMENU05 = '(5) Electric Guitar';
	/// block: sound, instruments_menu
	Blockly.Msg.SOUND_INSTRUMENTSMENU06 = '(6) Bass';
	/// block: sound, instruments_menu
	Blockly.Msg.SOUND_INSTRUMENTSMENU07 = '(7) Pizzicato';
	/// block: sound, instruments_menu
	Blockly.Msg.SOUND_INSTRUMENTSMENU08 = '(8) Cello';
	/// block: sound, instruments_menu
	Blockly.Msg.SOUND_INSTRUMENTSMENU09 = '(9) Trombone';
	/// block: sound, instruments_menu
	Blockly.Msg.SOUND_INSTRUMENTSMENU10 = '(10) Clarinet';
	/// block: sound, instruments_menu
	Blockly.Msg.SOUND_INSTRUMENTSMENU11 = '(11) Saxophone';
	/// block: sound, instruments_menu
	Blockly.Msg.SOUND_INSTRUMENTSMENU12 = '(12) Flute';
	/// block: sound, instruments_menu
	Blockly.Msg.SOUND_INSTRUMENTSMENU13 = '(13) Wooden Flute';
	/// block: sound, instruments_menu
	Blockly.Msg.SOUND_INSTRUMENTSMENU14 = '(14) Bassoon';
	/// block: sound, instruments_menu
	Blockly.Msg.SOUND_INSTRUMENTSMENU15 = '(15) Choir';
	/// block: sound, instruments_menu
	Blockly.Msg.SOUND_INSTRUMENTSMENU16 = '(16) Vibraphone';
	/// block: sound, instruments_menu
	Blockly.Msg.SOUND_INSTRUMENTSMENU17 = '(17) Music Box';
	/// block: sound, instruments_menu
	Blockly.Msg.SOUND_INSTRUMENTSMENU18 = '(18) Steel Drum';
	/// block: sound, instruments_menu
	Blockly.Msg.SOUND_INSTRUMENTSMENU19 = '(19) Marimba';
	/// block: sound, instruments_menu
	Blockly.Msg.SOUND_INSTRUMENTSMENU20 = '(20) Synth Lead';
	/// block: sound, instruments_menu
	Blockly.Msg.SOUND_INSTRUMENTSMENU21 = '(21) Synth Pad';
	/// block: sound, effects_menu
	...
	/// block: events, whenflagclicked
	Blockly.Msg.EVENTS_WHENFLAGCLICKED = 'when %1 clicked';
	/// block: events, whenkeypressed
	Blockly.Msg.EVENTS_WHENKEYPRESSED = 'when %1 key pressed';
	/// block: events, whenthisspriteclicked
	Blockly.Msg.EVENTS_WHENTHISSPRITECLICKED = 'when this sprite clicked';
	/// block: events, whenbackdropswitchesto
	Blockly.Msg.EVENTS_WHENBACKDROPSWITCHESTO = 'when backdrop switches to %1';
	/// block: events, whengreaterthan
	Blockly.Msg.EVENTS_WHENGREATERTHAN = 'when %1 > %2';
	/// block: events, whenbroadcastreceived
	Blockly.Msg.EVENTS_WHENBROADCASTRECEIVED = 'when I receive %1';
	/// block: events, broadcast
	Blockly.Msg.EVENTS_BROADCAST = 'broadcast %1';
	/// block: events, broadcastandwait
	Blockly.Msg.EVENTS_BROADCASTANDWAIT = 'broadcast %1 and wait';
	/// block: events, whenkeypressedmenu
	Blockly.Msg.EVENTS_WHENKEYPRESSEDMENUSPACE = 'space';
	/// block: events, whenkeypressedmenu
	Blockly.Msg.EVENTS_WHENKEYPRESSEDMENULEFT = 'left arrow';
	/// block: events, whenkeypressedmenu
	Blockly.Msg.EVENTS_WHENKEYPRESSEDMENURIGHT = 'right arrow';
	/// block: events, whenkeypressedmenu
	Blockly.Msg.EVENTS_WHENKEYPRESSEDMENUDOWN = 'down arrow';
	/// block: events, whenkeypressedmenu
	Blockly.Msg.EVENTS_WHENKEYPRESSEDMENUUP = 'up arrow';
	/// block: events, whenkeypressedmenu
	Blockly.Msg.EVENTS_WHENKEYPRESSEDMENUANY = 'any';
	/// block: events, broadcastmenu
	Blockly.Msg.EVENTS_BROADCASTMENUMSG1 = 'message1';
	/// block: events, broadcastmenu
	Blockly.Msg.EVENTS_BROADCASTMENUMSG2 = 'message2';
	/// block: events, broadcastmenu
	Blockly.Msg.EVENTS_BROADCASTMENUNEWMSG = 'new message';
	/// block: events, whengreaterthanmenu
	Blockly.Msg.EVENTS_WHENGREATERTHANMENUTIMER = 'timer';

	/// category: control
	Blockly.Msg.CATEGORY_CONTROL = 'Control';
	/// block: control, wait
	Blockly.Msg.CONTROL_WAIT = 'wait %1 secs';
	...
	Blockly.Msg.CONTROL_IF_ELSE = 'if %1 then';
	/// block: control, if_else
	Blockly.Msg.CONTROL_IF_ELSE_ELSE = 'else';
	/// block: control, wait_until
	Blockly.Msg.CONTROL_WAIT_UNTIL = 'wait until %1';
	/// block: control, repeat_until
	Blockly.Msg.CONTROL_REPEAT_UNTIL = 'repeat until %1';
	/// block: control, stop
	Blockly.Msg.CONTROL_STOP = 'stop';
	/// block: control, start_as_clone
	Blockly.Msg.CONTROL_START_AS_CLONE = 'when I start as a clone';
	/// block: control, create_clone_of
	Blockly.Msg.CONTROL_CREATE_CLONE_OF = 'create clone of %1';
	/// block: control, delete_this_clone
	Blockly.Msg.CONTROL_DELETE_THIS_CLONE = 'delete this clone';
	/// block: control, stop options
	Blockly.Msg.CONTROL_STOPMENUALL = 'all';
	/// block: control, stop options
	Blockly.Msg.CONTROL_STOPMENUTHIS = 'this script';
	/// block: control, stop options
	Blockly.Msg.CONTROL_STOPMENUOTHER = 'other scripts in sprite';
	/// block: control, create_clone_of menu
	Blockly.Msg.CONTROL_CREATE_CLONE_OF_MYSELF = 'myself';

	/// category: sensing
	Blockly.Msg.CATEGORY_SENSING = 'Sensing';
	/// block: sensing, touchingobject
	Blockly.Msg.SENSING_TOUCHINGOBJECT = 'touching %1?';
	/// block: sensing, touchingcolor
	Blockly.Msg.SENSING_TOUCHINGCOLOR = 'touching color %1?';
	/// block: sensing, coloristouchingcolor
	Blockly.Msg.SENSING_COLORISTOUCHINGCOLOR = 'color %1 is touching %2?';
	/// block: sensing, distanceto
	Blockly.Msg.SENSING_DISTANCETO = 'distance to %1';
	/// block: sensing, keypressed
	Blockly.Msg.SENSING_KEYPRESSED = 'key %1 pressed?';
	/// block: sensing, mousedown
	Blockly.Msg.SENSING_MOUSEDOWN = 'mouse down?';
	/// block: sensing, mousex
	Blockly.Msg.SENSING_MOUSEX = 'mouse x';
	/// block: sensing, mousey
	Blockly.Msg.SENSING_MOUSEY = 'mouse y';
	/// block: sensing, loudness
	Blockly.Msg.SENSING_LOUDNESS = 'loudness';
	/// block: sensing, timer
	Blockly.Msg.SENSING_TIMER = 'timer';
	/// block: sensing, resettimer
	Blockly.Msg.SENSING_RESETTIMER = 'reset timer';
	/// block: sensing, of
	Blockly.Msg.SENSING_OF = '%1 of %2';
	/// block: sensing, current
	Blockly.Msg.SENSING_CURRENT = 'current %1';
	/// block: sensing, dayssince2000
	Blockly.Msg.SENSING_DAYSSINCE2000 = 'days since 2000';
	/// block: sensing, touchingobjectmenu
	Blockly.Msg.SENSING_TOUCHINGOBJECTMENUMOUSEPOINTER = 'mouse-pointer';
	/// block: sensing, touchingobjectmenu
	Blockly.Msg.SENSING_TOUCHINGOBJECTMENUEDGE = 'edge';
	/// block: sensing, distancetomenu
	Blockly.Msg.SENSING_DISTANCETOMENUMOUSEPOINTER = 'mouse-pointer';
	/// block: sensing, keyoptions
	Blockly.Msg.SENSING_KEYMENUSPACE = 'space';
	/// block: sensing, keyoptions
	Blockly.Msg.SENSING_KEYMENULEFT = 'left arrow';
	/// block: sensing, keyoptions
	Blockly.Msg.SENSING_KEYMENURIGHT = 'right arrow';
	/// block: sensing, keyoptions
	Blockly.Msg.SENSING_KEYMENUDOWN = 'down arrow';
	/// block: sensing, keyoptions
	Blockly.Msg.SENSING_KEYMENUUP = 'up arrow';
	/// block: sensing, keyoptions
	Blockly.Msg.SENSING_KEYMENUANY = 'any';
	/// block: sensing, sensing_of_property_menu
	Blockly.Msg.SENSING_OFMENUXPOSITION = 'x position';
	/// block: sensing, sensing_of_property_menu
	Blockly.Msg.SENSING_OFMENUYPOSITION = 'y position';
	/// block: sensing, sensing_of_property_menu
	Blockly.Msg.SENSING_OFMENUDIRECTION = 'direction';
	/// block: sensing, sensing_of_property_menu
	Blockly.Msg.SENSING_OFMENUCOSTUMEORDER = 'costume #';
	/// block: sensing, sensing_of_property_menu
	Blockly.Msg.SENSING_OFMENUCOSTUMENAME = 'costume name';
	/// block: sensing, sensing_of_property_menu
	Blockly.Msg.SENSING_OFMENUSIZE = 'size';
	/// block: sensing, sensing_of_property_menu
	Blockly.Msg.SENSING_OFMENUVOLUME = 'volume';
	/// block: sensing, sensing_of_property_menu
	Blockly.Msg.SENSING_OFMENUBACKDROPORDER = 'backdrop #';
	/// block: sensing, sensing_of_property_menu
	Blockly.Msg.SENSING_OFMENUBACKDROPNAME = 'backdrop name';
	/// block: sensing, currentmenu
	Blockly.Msg.SENSING_CURRENTMENUYEAR = 'year';
	/// block: sensing, currentmenu
	Blockly.Msg.SENSING_CURRENTMENUMONTH = 'month';
	/// block: sensing, currentmenu
	Blockly.Msg.SENSING_CURRENTMENUDATE = 'date';
	/// block: sensing, currentmenu
	Blockly.Msg.SENSING_CURRENTMENUWEEK = 'day of week';
	/// block: sensing, currentmenu
	Blockly.Msg.SENSING_CURRENTMENUHOUR = 'hour';
	/// block: sensing, currentmenu
	Blockly.Msg.SENSING_CURRENTMENUMINUTE = 'minute';
	/// block: sensing, currentmenu
	Blockly.Msg.SENSING_CURRENTMENUSECOND = 'second';

	/// category: operators
	Blockly.Msg.CATEGORY_OPERATORS = 'Operators';
	/// block: operators, random
	...
	/// block: operators, join
	Blockly.Msg.OPERATORS_JOIN = 'join %1 %2';
	/// block: operators, letter_of
	Blockly.Msg.OPERATORS_LETTER_OF = 'letter %1 of %2';
	/// block: operators, length
	Blockly.Msg.OPERATORS_LENGTH = 'length of %1';
	/// block: operators, mod
	Blockly.Msg.OPERATORS_MOD = '%1 mod %2';
	/// block: operators, round
	Blockly.Msg.OPERATORS_ROUND = 'round %1';
	/// block: operators, mathop
	Blockly.Msg.OPERATORS_MATHOP = '%1 of %2';
	/// block: operators, operator_mathop options
	Blockly.Msg.OPERATORS_MATHOPABS = 'abs';
	/// block: operators, operator_mathop options
	Blockly.Msg.OPERATORS_MATHOPFLOOR = 'floor';
	/// block: operators, operator_mathop options
	Blockly.Msg.OPERATORS_MATHOPCEILING = 'ceiling';
	/// block: operators, operator_mathop options
	Blockly.Msg.OPERATORS_MATHOPSQRT = 'sqrt';

	/// category: data
	Blockly.Msg.CATEGORY_DATA = 'Data';
	/// block: data, setvariableto
	Blockly.Msg.DATA_SETVARIABLETO = 'set %1 to %2';
	/// block: data, changevariableby
	Blockly.Msg.DATA_CHANGEVARIABLEBY = 'change %1 by %2';
	/// block: data, addtolist
	Blockly.Msg.DATA_ADDTOLIST = 'add %1 to %2';
	/// block: data, deleteoflist
	Blockly.Msg.DATA_DELETEOFLIST = 'delete %1 of %2';
	/// block: data, insertatlist
	Blockly.Msg.DATA_INSERTATLIST = 'insert %1 at %2 of %3';
	/// block: data, replaceitemoflist
	Blockly.Msg.DATA_REPLACEITEMOFLIST = 'replace item %1 of %2 with %3';
	/// block: data, itemoflist
	Blockly.Msg.DATA_ITEMOFLIST = 'item %1 of %2';
	/// block: data, lengthoflist
	Blockly.Msg.DATA_LENGTHOFLIST = 'length of %1';
	/// block: data, listcontainsitem
	Blockly.Msg.DATA_LISTCONTAINSITEM = '%1 contains %2?';
	/// block: data, showlist
	Blockly.Msg.DATA_SHOWLIST = 'show list %1';
	/// block: data, hidelist
	Blockly.Msg.DATA_HIDELIST = 'hide list %1';
	/// block: data, listindexall
	Blockly.Msg.DATA_LISTINDEXALLLAST = 'last';
	/// block: data, listindexall
	Blockly.Msg.DATA_LISTINDEXALLALL = 'all';
	/// block: data, listindexrandom
	Blockly.Msg.DATA_LISTINDEXRANDOMLAST = 'last';
	/// block: data, listindexrandom
	Blockly.Msg.DATA_LISTINDEXRANDOMRANDOM = 'random';

	/// category: electronics
	Blockly.Msg.CATEGORY_ELECTRONICSOUTPUT = 'Output';
	/// category: electronics
	Blockly.Msg.CATEGORY_ELECTRONICSSENSOR = 'Sensor';
	/// category: electronics
	Blockly.Msg.CATEGORY_ELECTRONICSINPUT = 'Input';
	/// category: electronics
	Blockly.Msg.CATEGORY_ELECTRONICSCOMMUNICATE = 'Communicate';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_LEDMENU_ON = 'on';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_LEDMENU_OFF = 'off';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_PORTMENU_1 = 'port1';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_PORTMENU_2 = 'port2';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_PORTMENU_3 = 'port3';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_PORTMENU_4 = 'port4';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_PORTMENU_5 = 'port5';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_PORTMENU_6 = 'port6';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_SETLED = 'set led %1 %2';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_ARDUINOMAINSETUP = 'When cubic started';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_ARDUINOMAINLOOP = 'forever';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_TSPRESSED = 'touch switch %1 pressed?';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_SONAR = 'ultrasonic %1 distance';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_LEDDIGITDISPLAYXY = 'LED digital display %1 show %2 : %3';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_LEDDIGITDISPLAY = 'LED digital display %1 show %2';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_RGBLAMP = 'set RGB lamp %1 %2 R: %3 G: %4 B: %5';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_RGBLAMPPICK = 'set RGB lamp %1 %2 %3';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_IRDETECTORSENSOR = 'IR detector sensor %1 detected?';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_LIGHTSENSORDETECTED = 'light sensor %1 detected light?';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_LIGHTSENSOR = 'light sensor %1 value';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_TEMPHUMIDITYSENSORTEMP = 'temp&humidity sensor %1 temp';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_TEMPHUMIDITYSENSORHUMIDITY = 'temp&humidity sensor %1 humidity';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_ROTARYKNOB = 'rotary knob %1 value';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_SOUNDSENSORDETECTED = 'sound sensor %1 detected sound?';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_SOUNDSENSOR = 'sound sensor %1 value';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_BUZZERALARM = 'buzzer %1 alarm';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_BUZZERSTOP = 'buzzer %1 stop';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_BUZZERRING = 'buzzer %1 ring with %2 Hz';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_BUZZERNOTE = 'buzzer %1 play note %2 %3 for %4 beats';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_GYRO = 'gyro %1 %2 axis %3';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_GYROMENU_ANGLE = 'angle';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_GYROMENU_ACCELE = 'acceleration';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_GYROMENU_ANGULAR = 'angular acceleration';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_DCMOTORGO = 'DC motor %1 %2 speed %3';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_DCMOTORSTOP = 'DC motor %1 stop';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_DCMCGO = 'DC Motor control %1 %2 %3, speed %4';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_DCMCSTOP = 'DC Motor control %1 %2 stop';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_SERVOGOTOANGLE = 'servo %1 goto angle %2 in %3 secs';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_SERVOCURRENTANGLE = 'servo %1 current angle';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_IRTRACKINGVALUE = 'Infrared Tracking %1 value';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_IRTRACKING = 'Infrared Tracking %1 %2?';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_IRTRANSCEIVERCODE = 'IR transceiver %1 received code';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_IRTRANSCEIVERCODESEND = 'IR transceiver %1 send code %2';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_IRREMOTEKEYPRESSED = 'IR remote %1 %2 pressed?';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_IRREMOTEKEYCODE = 'IR remote key %1 code';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_JOYSTICK = 'joystick %1 %2 axis value';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_JOYSTICKPRESSED = 'joystick %1 pressed?';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_KEYS = 'keys %1 value';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_GYROCALIBRATE = 'gyro %1 calibrate';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_WATERTEMP = 'water temp sensor %1 value';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_RAINDROP = 'raindrop sensor %1 value';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_SOILHUMIDITY = 'soil humidity sensor %1 value';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_FLAME = 'flame detector %1 value';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_FLAMEDETECTED = 'flame detector %1 detected?';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_SMOKE = 'smoke detector %1 value';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_SMOKEDETECTED = 'smoke detector %1 detected?';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_MOTORMENU_FORWARD = 'forward';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_MOTORMENU_BACKWARD = 'backward';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_BUZZERMENU_TREBLE = 'treble';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_BUZZERMENU_ALTO = 'alto';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_BUZZERMENU_BASS = 'bass';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_IRMENU_NONE = 'none black';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_IRMENU_ONE = '#1 black';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_IRMENU_TWO = '#2 black';
	/// category: electronics
	Blockly.Msg.ELECTRONICS_IRMENU_BOTH = 'both black';
...
/***/ function(module, exports, __webpack_require__) {
	...
	/*** IMPORTS FROM imports-loader ***/
	var Blockly = __webpack_require__(4);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(7).Blockly;
...
/***/ function(module, exports) {
	...
	a("es6-impl",function(){return!0});a("es7",function(){return b("2 ** 2 == 4")});a("es8",function(){return b("async () => 1, true")});return c};goog.a11y={};goog.a11y.aria={};
	...
	goog.a11y.aria.GrabbedValues={TRUE:"true",FALSE:"false",UNDEFINED:"undefined"};goog.a11y.aria.InvalidValues={FALSE:"false",TRUE:"true",GRAMMAR:"grammar",SPELLING:"spelling"};goog.a11y.aria.PressedValues={TRUE:"true",FALSE:"false",MIXED:"mixed",UNDEFINED:"undefined"};goog.a11y.aria.SelectedValues={TRUE:"true",FALSE:"false",UNDEFINED:"undefined"};goog.object={};goog.object.is=function(a,b){return a===b?0!==a||1/a===1/b:a!==a&&b!==b};goog.object.forEach=function(a,b,c){for(var d in a)b.call(c,a[d],d,a)};goog.object.filter=function(a,b,c){var d={},e;for(e in a)b.call(c,a[e],e,a)&&(d[e]=a[e]);return d};goog.object.map=function(a,b,c){var d={},e;for(e in a)d[e]=b.call(c,a[e],e,a);return d};goog.object.some=function(a,b,c){for(var d in a)if(b.call(c,a[d],d,a))return!0;return!1};
	...
	goog.object.getAllPropertyNames=function(a,b,c){if(!a)return[];if(!Object.getOwnPropertyNames||!Object.getPrototypeOf)return goog.object.getKeys(a);for(var d={};a&&(a!==Object.prototype||b)&&(a!==Function.prototype||c);){for(var e=Object.getOwnPropertyNames(a),f=0;f<e.length;f++)d[e[f]]=!0;a=Object.getPrototypeOf(a)}return goog.object.getKeys(d)};goog.a11y.aria.datatables={};
	...
	"additions text",goog.a11y.aria.State.REQUIRED,!1,goog.a11y.aria.State.SORT,"none",goog.a11y.aria.State.BUSY,!1,goog.a11y.aria.State.DISABLED,!1,goog.a11y.aria.State.HIDDEN,!1,goog.a11y.aria.State.INVALID,"false"));return goog.a11y.aria.DefaultStateValueMap_};goog.debug={};goog.debug.Error=function(a){if(Error.captureStackTrace)Error.captureStackTrace(this,goog.debug.Error);else{var b=Error().stack;b&&(this.stack=b)}a&&(this.message=String(a));this.reportErrorToServer=!0};goog.inherits(goog.debug.Error,Error);goog.debug.Error.prototype.name="CustomError";goog.dom={};goog.dom.NodeType={ELEMENT:1,ATTRIBUTE:2,TEXT:3,CDATA_SECTION:4,ENTITY_REFERENCE:5,ENTITY:6,PROCESSING_INSTRUCTION:7,COMMENT:8,DOCUMENT:9,DOCUMENT_TYPE:10,DOCUMENT_FRAGMENT:11,NOTATION:12};goog.string={};goog.string.DETECT_DOUBLE_ESCAPING=!1;goog.string.FORCE_NON_DOM_HTML_UNESCAPING=!1;goog.string.Unicode={NBSP:"\u00a0"};goog.string.startsWith=function(a,b){return 0==a.lastIndexOf(b,0)};goog.string.endsWith=function(a,b){var c=a.length-b.length;return 0<=c&&a.indexOf(b,c)==c};goog.string.caseInsensitiveStartsWith=function(a,b){return 0==goog.string.caseInsensitiveCompare(b,a.substr(0,b.length))};
	...
	goog.a11y.aria.isContainerRole=function(a){a=goog.a11y.aria.getRole(a);return goog.array.contains(goog.a11y.aria.CONTAINER_ROLES_,a)};goog.a11y.aria.splitStringOnWhitespace_=function(a){return a?a.split(/\s+/):[]};goog.a11y.aria.getAriaAttributeName_=function(a){goog.asserts.ENABLE_ASSERTS&&(goog.asserts.assert(a,"ARIA attribute cannot be empty."),goog.asserts.assert(goog.object.containsValue(goog.a11y.aria.State,a),"No such ARIA attribute "+a));return goog.a11y.aria.ARIA_PREFIX_+a};goog.disposable={};goog.disposable.IDisposable=function(){};goog.disposable.IDisposable.prototype.dispose=goog.abstractMethod;goog.disposable.IDisposable.prototype.isDisposed=goog.abstractMethod;goog.Disposable=function(){goog.Disposable.MONITORING_MODE!=goog.Disposable.MonitoringMode.OFF&&(goog.Disposable.INCLUDE_STACK_ON_CREATION&&(this.creationStack=Error().stack),goog.Disposable.instances_[goog.getUid(this)]=this);this.disposed_=this.disposed_;this.onDisposeCallbacks_=this.onDisposeCallbacks_};goog.Disposable.MonitoringMode={OFF:0,PERMANENT:1,INTERACTIVE:2};goog.Disposable.MONITORING_MODE=0;goog.Disposable.INCLUDE_STACK_ON_CREATION=!0;goog.Disposable.instances_={};
	...
	goog.events.wrapListener=function(a){goog.asserts.assert(a,"Listener can not be null.");if(goog.isFunction(a))return a;goog.asserts.assert(a.handleEvent,"An object listener must have handleEvent method.");a[goog.events.LISTENER_WRAPPER_PROP_]||(a[goog.events.LISTENER_WRAPPER_PROP_]=function(b){return a.handleEvent(b)});return a[goog.events.LISTENER_WRAPPER_PROP_]};goog.debug.entryPointRegistry.register(function(a){goog.events.handleBrowserEvent_=a(goog.events.handleBrowserEvent_)});goog.functions={};goog.functions.constant=function(a){return function(){return a}};goog.functions.FALSE=goog.functions.constant(!1);goog.functions.TRUE=goog.functions.constant(!0);goog.functions.NULL=goog.functions.constant(null);goog.functions.identity=function(a,b){return a};goog.functions.error=function(a){return function(){throw Error(a);}};goog.functions.fail=function(a){return function(){throw a;}};
	...
	goog.async.Delay.prototype.isActive=function(){return 0!=this.id_};goog.async.Delay.prototype.doAction_=function(){this.id_=0;this.listener_&&this.listener_.call(this.handler_)};goog.color={};
	...
	goog.debug.LogManager.createLogger_=function(a){var b=new goog.debug.Logger(a);if(goog.debug.Logger.ENABLE_HIERARCHY){var c=a.lastIndexOf("."),d=a.substr(0,c),c=a.substr(c+1),d=goog.debug.LogManager.getLogger(d);d.addChild_(c,b);b.setParent_(d)}return goog.debug.LogManager.loggers_[a]=b};goog.dom.animationFrame={};goog.dom.animationFrame.polyfill={};goog.dom.animationFrame.polyfill.ENABLED=!0;
	...
	goog.dom.TagIterator.prototype.equals=function(a){return a.node==this.node&&(!this.node||a.tagType==this.tagType)};goog.dom.TagIterator.prototype.splice=function(a){var b=this.node;this.restartTag();this.reversed=!this.reversed;goog.dom.TagIterator.prototype.next.call(this);this.reversed=!this.reversed;for(var c=goog.isArrayLike(arguments[0])?arguments[0]:arguments,d=c.length-1;0<=d;d--)goog.dom.insertSiblingAfter(c[d],b);goog.dom.removeNode(b)};goog.dom.NodeIterator=function(a,b,c,d){goog.dom.TagIterator.call(this,a,b,c,null,d)};goog.inherits(goog.dom.NodeIterator,goog.dom.TagIterator);goog.dom.NodeIterator.prototype.next=function(){do goog.dom.NodeIterator.superClass_.next.call(this);while(this.isEndTag());return this.node};goog.dom.vendor={};goog.dom.vendor.getVendorJsPrefix=function(){return goog.userAgent.WEBKIT?"Webkit":goog.userAgent.GECKO?"Moz":goog.userAgent.IE?"ms":goog.userAgent.OPERA?"O":null};goog.dom.vendor.getVendorPrefix=function(){return goog.userAgent.WEBKIT?"-webkit":goog.userAgent.GECKO?"-moz":goog.userAgent.IE?"-ms":goog.userAgent.OPERA?"-o":null};
	goog.dom.vendor.getPrefixedPropertyName=function(a,b){if(b&&a in b)return a;var c=goog.dom.vendor.getVendorJsPrefix();return c?(c=c.toLowerCase(),a=c+goog.string.toTitleCase(a),!goog.isDef(b)||a in b?a:null):null};goog.dom.vendor.getPrefixedEventType=function(a){return((goog.dom.vendor.getVendorJsPrefix()||"")+a).toLowerCase()};goog.events.EventHandler=function(a){goog.Disposable.call(this);this.handler_=a;this.keys_={}};goog.inherits(goog.events.EventHandler,goog.Disposable);goog.events.EventHandler.typeArray_=[];goog.events.EventHandler.prototype.listen=function(a,b,c,d){return this.listen_(a,b,c,d)};goog.events.EventHandler.prototype.listenWithScope=function(a,b,c,d,e){return this.listen_(a,b,c,d,e)};
	...
	goog.fx.anim.cycleAnimations_=function(a){goog.object.forEach(goog.fx.anim.activeAnimations_,function(b){b.onAnimationFrame(a)});goog.object.isEmpty(goog.fx.anim.activeAnimations_)||goog.fx.anim.requestAnimationFrame_()};goog.fx.Transition=function(){};goog.fx.Transition.EventType={PLAY:"play",BEGIN:"begin",RESUME:"resume",END:"end",STOP:"stop",FINISH:"finish",PAUSE:"pause"};goog.fx.TransitionBase=function(){goog.events.EventTarget.call(this);this.state_=goog.fx.TransitionBase.State.STOPPED;this.endTime=this.startTime=null};goog.inherits(goog.fx.TransitionBase,goog.events.EventTarget);goog.fx.TransitionBase.State={STOPPED:0,PAUSED:-1,PLAYING:1};goog.fx.TransitionBase.prototype.play=goog.abstractMethod;goog.fx.TransitionBase.prototype.stop=goog.abstractMethod;goog.fx.TransitionBase.prototype.pause=goog.abstractMethod;goog.fx.TransitionBase.prototype.getStateInternal=function(){return this.state_};
	...
	goog.fx.AnimationSerialQueue.prototype.onAnimationFinish=function(a){this.isPlaying()&&(this.current_++,this.current_<this.queue.length?this.queue[this.current_].play():(this.endTime=goog.now(),this.setStateStopped(),this.onFinish(),this.onEnd()))};goog.style.bidi={};goog.style.bidi.getScrollLeft=function(a){var b=goog.style.isRightToLeft(a);return b&&goog.userAgent.GECKO?-a.scrollLeft:!b||goog.userAgent.EDGE_OR_IE&&goog.userAgent.isVersionOrHigher("8")||"visible"==goog.style.getComputedOverflowX(a)?a.scrollLeft:a.scrollWidth-a.clientWidth-a.scrollLeft};
	...
	goog.fx.dom.ColorTransform=function(a,b,c,d,e){if(3!=b.length||3!=c.length)throw Error("Start and end points must be 3D");goog.fx.dom.PredefinedEffect.apply(this,arguments)};goog.inherits(goog.fx.dom.ColorTransform,goog.fx.dom.PredefinedEffect);goog.fx.dom.ColorTransform.prototype.updateStyle=function(){for(var a=[],b=0;b<this.coords.length;b++)a[b]=Math.round(this.coords[b]);a="rgb("+a.join(",")+")";this.element.style.color=a};goog.fx.Dragger=function(a,b,c){goog.events.EventTarget.call(this);this.target=a;this.handle=b||a;this.limits=c||new goog.math.Rect(NaN,NaN,NaN,NaN);this.document_=goog.dom.getOwnerDocument(a);this.eventHandler_=new goog.events.EventHandler(this);this.registerDisposable(this.eventHandler_);this.deltaY=this.deltaX=this.startY=this.startX=this.screenY=this.screenX=this.clientY=this.clientX=0;this.enabled_=!0;this.dragging_=!1;this.preventMouseDown_=!0;this.hysteresisDistanceSquared_=0;this.useRightPositioningForRtl_=
	this.ieDragStartCancellingOn_=!1;goog.events.listen(this.handle,[goog.events.EventType.TOUCHSTART,goog.events.EventType.MOUSEDOWN],this.startDrag,!1,this)};goog.inherits(goog.fx.Dragger,goog.events.EventTarget);goog.tagUnsealableClass(goog.fx.Dragger);goog.fx.Dragger.HAS_SET_CAPTURE_=goog.global.document&&goog.global.document.documentElement&&!!goog.global.document.documentElement.setCapture&&!!goog.global.document.releaseCapture;
	...
	goog.string.StringBuffer.prototype.toString=function(){return this.buffer_};goog.structs={};goog.structs.getCount=function(a){return a.getCount&&"function"==typeof a.getCount?a.getCount():goog.isArrayLike(a)||goog.isString(a)?a.length:goog.object.getCount(a)};goog.structs.getValues=function(a){if(a.getValues&&"function"==typeof a.getValues)return a.getValues();if(goog.isString(a))return a.split("");if(goog.isArrayLike(a)){for(var b=[],c=a.length,d=0;d<c;d++)b.push(a[d]);return b}return goog.object.getValues(a)};
	...
	goog.ui.Component.prototype.removeChildren=function(a){for(var b=[];this.hasChildren();)b.push(this.removeChildAt(0,a));return b};goog.ui.ControlRenderer=function(){};goog.addSingletonGetter(goog.ui.ControlRenderer);goog.tagUnsealableClass(goog.ui.ControlRenderer);goog.ui.ControlRenderer.getCustomRenderer=function(a,b){a=new a;a.getCssClass=function(){return b};return a};goog.ui.ControlRenderer.CSS_CLASS="goog-control";goog.ui.ControlRenderer.IE6_CLASS_COMBINATIONS=[];
	...
	a.currentTarget));goog.ui.Control.IeMouseEventSequenceSimulator_.SYNTHETIC_EVENTS_||(b.button=c,b.type=d)}};goog.ui.Control.IeMouseEventSequenceSimulator_.prototype.disposeInternal=function(){this.control_=null;goog.ui.Control.IeMouseEventSequenceSimulator_.superClass_.disposeInternal.call(this)};goog.ui.PaletteRenderer=function(){goog.ui.ControlRenderer.call(this)};goog.inherits(goog.ui.PaletteRenderer,goog.ui.ControlRenderer);goog.addSingletonGetter(goog.ui.PaletteRenderer);goog.ui.PaletteRenderer.cellId_=0;goog.ui.PaletteRenderer.CSS_CLASS="goog-palette";goog.ui.PaletteRenderer.prototype.createDom=function(a){var b=this.getClassNames(a);a=a.getDomHelper().createDom("DIV",b,this.createGrid(a.getContent(),a.getSize(),a.getDomHelper()));goog.a11y.aria.setRole(a,goog.a11y.aria.Role.GRID);return a};
	...
	goog.ui.SliderBase.prototype.addRangeHighlightAnimations_=function(a,b,c,d,e){var f=this.getThumbCoordinateForValue(b);var g=this.getThumbCoordinateForValue(b+c);b=f;c=g;a==this.valueThumb?b=d:c=d;this.orientation_==goog.ui.SliderBase.Orientation.VERTICAL?(d=this.calculateRangeHighlightPositioning_(g.y,f.y,this.valueThumb.offsetHeight),f=this.calculateRangeHighlightPositioning_(c.y,b.y,this.valueThumb.offsetHeight),a=new goog.fx.dom.Slide(this.rangeHighlight,[this.getOffsetStart_(this.rangeHighlight),
	d.offset],[this.getOffsetStart_(this.rangeHighlight),f.offset],goog.ui.SliderBase.ANIMATION_INTERVAL_),d=new goog.fx.dom.ResizeHeight(this.rangeHighlight,d.size,f.size,goog.ui.SliderBase.ANIMATION_INTERVAL_)):(d=this.calculateRangeHighlightPositioning_(f.x,g.x,this.valueThumb.offsetWidth),f=this.calculateRangeHighlightPositioning_(b.x,c.x,this.valueThumb.offsetWidth),a=new goog.fx.dom.Slide(this.rangeHighlight,[d.offset,this.rangeHighlight.offsetTop],[f.offset,this.rangeHighlight.offsetTop],goog.ui.SliderBase.ANIMATION_INTERVAL_),
	d=new goog.fx.dom.ResizeWidth(this.rangeHighlight,d.size,f.size,goog.ui.SliderBase.ANIMATION_INTERVAL_));a.enableRightPositioningForRtl(this.flipForRtl_);d.enableRightPositioningForRtl(this.flipForRtl_);e.add(a);e.add(d)};goog.ui.SliderBase.prototype.endAnimation_=function(a){this.isAnimating_=!1;this.dispatchEvent(goog.ui.SliderBase.EventType.ANIMATION_END)};
	...
	goog.ui.Slider.prototype.getCssClass=function(a){return a==goog.ui.SliderBase.Orientation.VERTICAL?goog.ui.Slider.CSS_CLASS_PREFIX+"-vertical":goog.ui.Slider.CSS_CLASS_PREFIX+"-horizontal"};goog.ui.Slider.prototype.createThumbs=function(){var a=this.getElement(),b=goog.dom.getElementsByTagNameAndClass(null,goog.ui.Slider.THUMB_CSS_CLASS,a)[0];b||(b=this.createThumb_(),a.appendChild(b));this.valueThumb=this.extentThumb=b};
	goog.ui.Slider.prototype.createThumb_=function(){var a=this.getDomHelper().createDom("DIV",goog.ui.Slider.THUMB_CSS_CLASS);goog.a11y.aria.setRole(a,goog.a11y.aria.Role.BUTTON);return a};goog.ui.tree={};goog.ui.tree.BaseNode=function(a,b,c){goog.ui.Component.call(this,c);this.config_=b||goog.ui.tree.BaseNode.defaultConfig;this.html_=goog.html.SafeHtml.htmlEscapePreservingNewlines(a);this.expanded_=this.selected_=!1;this.toolTip_=null;this.afterLabelHtml_=goog.html.SafeHtml.EMPTY;this.isUserCollapsible_=!0;this.depth_=-1};goog.inherits(goog.ui.tree.BaseNode,goog.ui.Component);
	...
	*/
	...
	Blockly.Workspace.prototype.renameVariable=function(a,b){a=this.getVariable(a);this.renameVariableInternal_(a,b)};Blockly.Workspace.prototype.renameVariableById=function(a,b){a=this.getVariableById(a);this.renameVariableInternal_(a,b)};Blockly.Workspace.prototype.createVariable=function(a,b,c){if(a.toLowerCase()!=Blockly.Variables.noVariableText())return this.variableMap_.createVariable(a,b,c)};
	...
	Blockly.Workspace.prototype.variableIndexOf=function(){console.warn("Deprecated call to Blockly.Workspace.prototype.variableIndexOf");return-1};Blockly.Workspace.prototype.getVariable=function(a){return this.variableMap_.getVariable(a)};Blockly.Workspace.prototype.getVariableById=function(a){return this.variableMap_.getVariableById(a)};Blockly.Workspace.prototype.getWidth=function(){return 0};Blockly.Workspace.prototype.newBlock=function(a,b){return new Blockly.Block(this,a,b)};
	...
	*/
	...
	Blockly.bindEventWithChecks_(b,"mouseup",this,this.textareaFocus_);Blockly.bindEventWithChecks_(b,"wheel",this,function(a){a.stopPropagation()});Blockly.bindEventWithChecks_(b,"change",this,function(){this.text_!=b.value&&(Blockly.Events.fire(new Blockly.Events.BlockChange(this.block_,"comment",null,this.text_,b.value)),this.text_=b.value)});setTimeout(function(){b.focus()},0);return this.foreignObject_};
	...
	Blockly.INPUT_VALUE=1;Blockly.OUTPUT_VALUE=2;Blockly.NEXT_STATEMENT=3;Blockly.PREVIOUS_STATEMENT=4;Blockly.DUMMY_INPUT=5;Blockly.ALIGN_LEFT=-1;Blockly.ALIGN_CENTRE=0;Blockly.ALIGN_RIGHT=1;Blockly.DRAG_NONE=0;Blockly.DRAG_STICKY=1;Blockly.DRAG_BEGIN=1;Blockly.DRAG_FREE=2;Blockly.OPPOSITE_TYPE=[];Blockly.OPPOSITE_TYPE[Blockly.INPUT_VALUE]=Blockly.OUTPUT_VALUE;Blockly.OPPOSITE_TYPE[Blockly.OUTPUT_VALUE]=Blockly.INPUT_VALUE;Blockly.OPPOSITE_TYPE[Blockly.NEXT_STATEMENT]=Blockly.PREVIOUS_STATEMENT;
	Blockly.OPPOSITE_TYPE[Blockly.PREVIOUS_STATEMENT]=Blockly.NEXT_STATEMENT;Blockly.TOOLBOX_AT_TOP=0;Blockly.TOOLBOX_AT_BOTTOM=1;Blockly.TOOLBOX_AT_LEFT=2;Blockly.TOOLBOX_AT_RIGHT=3;Blockly.OUTPUT_SHAPE_HEXAGONAL=1;Blockly.OUTPUT_SHAPE_ROUND=2;Blockly.OUTPUT_SHAPE_SQUARE=3;Blockly.STACK_GLOW_RADIUS=1.3;Blockly.REPLACEMENT_GLOW_RADIUS=2;Blockly.Categories={motion:"motion",looks:"looks",sound:"sounds",pen:"pen",data:"data",event:"events",control:"control",sensing:"sensing",operators:"operators",more:"more"};
	Blockly.DELETE_AREA_NONE=null;Blockly.DELETE_AREA_TRASH=1;Blockly.DELETE_AREA_TOOLBOX=2;Blockly.VARIABLE_CATEGORY_NAME="VARIABLE";Blockly.PROCEDURE_CATEGORY_NAME="PROCEDURE";Blockly.RENAME_VARIABLE_ID="RENAME_VARIABLE_ID";Blockly.DELETE_VARIABLE_ID="DELETE_VARIABLE_ID";Blockly.Variables={};Blockly.Variables.NAME_TYPE=Blockly.VARIABLE_CATEGORY_NAME;
	...
	Blockly.Variables.allVariables=function(a){return a instanceof Blockly.Block?(console.warn("Deprecated call to Blockly.Variables.allVariables with a block instead of a workspace.  You may want Blockly.Variables.allUsedVariables"),{}):a.getAllVariables()};Blockly.Variables.noVariableText=function(){return"No variable selected"};
	...
	Blockly.Variables.createVariable=function(a,b,c){var d=function(e){Blockly.Variables.promptName(Blockly.Msg.NEW_VARIABLE_TITLE,e,function(e){if(e)if(a.getVariable(e))Blockly.alert(Blockly.Msg.VARIABLE_ALREADY_EXISTS.replace("%1",e.toLowerCase()),function(){d(e)});else if(Blockly.Procedures.isNameUsed(e,a)){var f=a.createVariable(e,c),h=a.getFlyout(),f=f.getId();h.setCheckboxState&&h.setCheckboxState(f,!0);b&&b(e)}else Blockly.alert(Blockly.Msg.PROCEDURE_ALREADY_EXISTS.replace("%1",e.toLowerCase()),
	function(){d(e)});else b&&b(null)})};d("")};
	Blockly.Variables.renameVariable=function(a,b,c){var d=function(e){Blockly.Variables.promptName(Blockly.Msg.RENAME_VARIABLE_TITLE.replace("%1",b.name),e,function(e){if(e){var f=a.getVariable(e);f&&f.type!=b.type?Blockly.alert(Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE.replace("%1",e.toLowerCase()).replace("%2",f.type),function(){d(e)}):Blockly.Procedures.isNameUsed(e,a)?(a.renameVariable(b.name,e),c&&c(e)):Blockly.alert(Blockly.Msg.PROCEDURE_ALREADY_EXISTS.replace("%1",e.toLowerCase()),
	function(){d(e)})}else c&&c(null)})};d("")};Blockly.Variables.promptName=function(a,b,c){Blockly.prompt(a,b,function(a){a&&(a=a.replace(/[\s\xa0]+/g," ").replace(/^ | $/g,""),a==Blockly.Msg.RENAME_VARIABLE||a==Blockly.Msg.NEW_VARIABLE)&&(a=null);c(a)})};Blockly.Variables.generateVariableFieldXml_=function(a,b){var c=goog.dom.createDom("field");c.setAttribute("name",b||"VARIABLE");c.setAttribute("variableType",a.type);c.setAttribute("id",a.getId());c.textContent=a.name;return Blockly.Xml.domToText(c)};Blockly.DataCategory=function(a){var b=a.getVariablesOfType("");b.sort(Blockly.VariableModel.compareByName);var c=[];Blockly.DataCategory.addCreateButton(c,a,"VARIABLE");for(var d=0;d<b.length;d++)Blockly.DataCategory.addDataVariable(c,b[d]);0<b.length&&(c[c.length-1].setAttribute("gap",24),b=b[0],Blockly.DataCategory.addSetVariableTo(c,b),Blockly.DataCategory.addChangeVariableBy(c,b),Blockly.DataCategory.addShowVariable(c,b),Blockly.DataCategory.addHideVariable(c,b));b=a.getVariablesOfType("list");
	b.sort(Blockly.VariableModel.compareByName);for(d=0;d<b.length;d++)Blockly.DataCategory.addDataVariable(c,b[d]);0<b.length&&(c[c.length-1].setAttribute("gap",24),b=b[0],Blockly.DataCategory.addAddToList(c,b),Blockly.DataCategory.addDeleteOfList(c,b),Blockly.DataCategory.addInsertAtList(c,b),Blockly.DataCategory.addReplaceItemOfList(c,b),Blockly.DataCategory.addItemOfList(c,b),Blockly.DataCategory.addLengthOfList(c,b),Blockly.DataCategory.addListContainsItem(c,b),Blockly.DataCategory.addShowList(c,
	b),Blockly.DataCategory.addHideList(c,b));return c};Blockly.DataCategory.addDataVariable=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_variable","VARIABLE");a[a.length-1].setAttribute("id",b.getId())};Blockly.DataCategory.addSetVariableTo=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_setvariableto","VARIABLE",["VALUE","text",0])};Blockly.DataCategory.addChangeVariableBy=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_changevariableby","VARIABLE",["VALUE","math_number",1])};
	Blockly.DataCategory.addShowVariable=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_showvariable","VARIABLE")};Blockly.DataCategory.addHideVariable=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_hidevariable","VARIABLE")};Blockly.DataCategory.addAddToList=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_addtolist","LIST",["ITEM","text","thing"])};
	Blockly.DataCategory.addDeleteOfList=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_deleteoflist","LIST",["INDEX","math_integer",1])};Blockly.DataCategory.addInsertAtList=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_insertatlist","LIST",["INDEX","math_integer",1],["ITEM","text","thing"])};Blockly.DataCategory.addReplaceItemOfList=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_replaceitemoflist","LIST",["INDEX","math_integer",1],["ITEM","text","thing"])};
	Blockly.DataCategory.addItemOfList=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_itemoflist","LIST",["INDEX","math_integer",1])};Blockly.DataCategory.addLengthOfList=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_lengthoflist","LIST")};Blockly.DataCategory.addListContainsItem=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_listcontainsitem","LIST",["ITEM","text","thing"])};Blockly.DataCategory.addShowList=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_showlist","LIST")};
	Blockly.DataCategory.addHideList=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_hidelist","LIST")};
	Blockly.DataCategory.addCreateButton=function(a,b,c){var d=goog.dom.createDom("button"),e=Blockly.Msg.NEW_VARIABLE,f="CREATE_VARIABLE",g=function(a){Blockly.Variables.createVariable(a.getTargetWorkspace())};"LIST"===c&&(e=Blockly.Msg.NEW_LIST,f="CREATE_LIST",g=function(a){Blockly.Variables.createVariable(a.getTargetWorkspace(),null,"list")});d.setAttribute("text",e);d.setAttribute("callbackKey",f);b.registerButtonCallback(f,g);a.push(d)};
	...
	Blockly.DataCategory.createValue=function(a,b,c){switch(a){case "ITEM":var d="TEXT";break;case "INDEX":d="NUM";break;case "VALUE":d="math_number"===b?"NUM":"TEXT"}return'<value name="'+a+'"><shadow type="'+b+'"><field name="'+d+'">'+c+"</field></shadow></value>"};Blockly.DropDownDiv=function(){};Blockly.DropDownDiv.DIV_=null;Blockly.DropDownDiv.boundsElement_=null;Blockly.DropDownDiv.owner_=null;Blockly.DropDownDiv.ARROW_SIZE=16;Blockly.DropDownDiv.BORDER_SIZE=1;Blockly.DropDownDiv.ARROW_HORIZONTAL_PADDING=12;Blockly.DropDownDiv.PADDING_Y=20;Blockly.DropDownDiv.ANIMATION_TIME=.25;Blockly.DropDownDiv.animateOutTimer_=null;Blockly.DropDownDiv.onHide_=0;
	...
	Blockly.DropDownDiv.hideWithoutAnimation=function(){if(Blockly.DropDownDiv.isVisible()){var a=Blockly.DropDownDiv.DIV_;Blockly.DropDownDiv.animateOutTimer_&&window.clearTimeout(Blockly.DropDownDiv.animateOutTimer_);a.style.transform="";a.style.top="";a.style.left="";a.style.display="none";Blockly.DropDownDiv.clearContent();Blockly.DropDownDiv.owner_=null;Blockly.DropDownDiv.onHide_&&(Blockly.DropDownDiv.onHide_(),Blockly.DropDownDiv.onHide_=null)}};Blockly.Events={};Blockly.Events.group_="";Blockly.Events.recordUndo=!0;Blockly.Events.disabled_=0;Blockly.Events.CREATE="create";Blockly.Events.BLOCK_CREATE=Blockly.Events.CREATE;Blockly.Events.DELETE="delete";Blockly.Events.BLOCK_DELETE=Blockly.Events.DELETE;Blockly.Events.CHANGE="change";Blockly.Events.BLOCK_CHANGE=Blockly.Events.CHANGE;Blockly.Events.MOVE="move";Blockly.Events.BLOCK_MOVE=Blockly.Events.MOVE;Blockly.Events.VAR_CREATE="var_create";Blockly.Events.VAR_DELETE="var_delete";
	...
	Blockly.InsertionMarkerManager.prototype.applyConnections=function(){this.closestConnection_&&(Blockly.Events.disable(),this.hidePreview_(),Blockly.Events.enable(),this.localConnection_.connect(this.closestConnection_),this.topBlock_.rendered&&((this.localConnection_.isSuperior()?this.closestConnection_:this.localConnection_).getSourceBlock().connectionUiEffect(),this.topBlock_.getRootBlock().bringToFront()))};
	...
	this.dispose())};Blockly.Gesture.prototype.cancel=function(){this.isEnding_?console.log("Trying to cancel a gesture recursively."):(this.isEnding_=!0,Blockly.longStop_(),this.isDraggingBlock_?this.blockDragger_.endBlockDrag(this.mostRecentEvent_,this.currentDragDeltaXY_):this.isDraggingWorkspace_&&this.workspaceDragger_.endDrag(this.currentDragDeltaXY_),this.dispose())};
	...
	Blockly.Grid.createDom=function(a,b,c){a=Blockly.utils.createSvgElement("pattern",{id:"blocklyGridPattern"+a,patternUnits:"userSpaceOnUse"},c);0<b.length&&0<b.spacing&&(Blockly.utils.createSvgElement("line",{stroke:b.colour},a),1<b.length&&Blockly.utils.createSvgElement("line",{stroke:b.colour},a));return a};Blockly.Options=function(a){var b,c,d,e,f,g=!!a.readOnly;if(g){var h=null;var k=b=c=d=e=f=!1}else!a.toolbox&&Blockly.Blocks.defaultToolbox&&(k=(new DOMParser).parseFromString(Blockly.Blocks.defaultToolbox,"text/xml"),a.toolbox=k.documentElement),h=Blockly.Options.parseToolboxTree(a.toolbox),f=!(!h||!h.getElementsByTagName("category").length),e=a.trashcan,void 0===e&&(e=!1),d=a.collapse,void 0===d&&(d=f),c=a.comments,void 0===c&&(c=f),b=a.disable,void 0===b&&(b=f),k=a.sounds,void 0===k&&(k=!0);var l=
	!!a.rtl,m=a.horizontalLayout;void 0===m&&(m=!1);var n=a.toolboxPosition;n="end"===n?!1:!0;var p=m?n?Blockly.TOOLBOX_AT_TOP:Blockly.TOOLBOX_AT_BOTTOM:n==l?Blockly.TOOLBOX_AT_RIGHT:Blockly.TOOLBOX_AT_LEFT;var q=a.scrollbars;void 0===q&&(q=f);var u=a.css;void 0===u&&(u=!0);var v="https://blockly-demo.appspot.com/static/media/";a.media?v=a.media:a.path&&(v=a.path+"media/");n=void 0===a.oneBasedIndex?!0:!!a.oneBasedIndex;var w=!!a.realtime,x=w?a.realtimeOptions:void 0,r=a.colours;if(r)for(var t in r)r.hasOwnProperty(t)&&
	Blockly.Colours.hasOwnProperty(t)&&(Blockly.Colours[t]=r[t]);this.RTL=l;this.oneBasedIndex=n;this.collapse=d;this.comments=c;this.disable=b;this.readOnly=g;this.pathToMedia=v;this.hasCategories=f;this.hasScrollbars=q;this.hasTrashcan=e;this.hasSounds=k;this.hasCss=u;this.horizontalLayout=m;this.languageTree=h;this.gridOptions=Blockly.Options.parseGridOptions_(a);this.zoomOptions=Blockly.Options.parseZoomOptions_(a);this.enableRealtime=w;this.realtimeOptions=x;this.toolboxPosition=p};
	...
	Blockly.Xml.blockToDom=function(a,b){var c,d=goog.dom.createDom(a.isShadow()?"shadow":"block");d.setAttribute("type",a.type);b||d.setAttribute("id",a.id);if(a.mutationToDom){var e=a.mutationToDom();e&&(e.hasChildNodes()||e.hasAttributes())&&d.appendChild(e)}for(var e=0,f;f=a.inputList[e];e++){var g=0;for(var h;h=f.fieldRow[g];g++){var k=h;if(k.name&&k.SERIALIZABLE){h=goog.dom.createDom("field",null,k.getValue());h.setAttribute("name",k.name);if(k instanceof Blockly.FieldVariable||k instanceof Blockly.FieldVariableGetter)if(k=
	a.workspace.getVariable(k.getValue()))h.setAttribute("id",k.getId()),h.setAttribute("variableType",k.type);d.appendChild(h)}}}if(e=a.getCommentText())e=goog.dom.createDom("comment",null,e),"object"==typeof a.comment&&(e.setAttribute("pinned",a.comment.isVisible()),f=a.comment.getBubbleSize(),e.setAttribute("h",f.height),e.setAttribute("w",f.width)),d.appendChild(e);a.data&&(e=goog.dom.createDom("data",null,a.data),d.appendChild(e));for(e=0;f=a.inputList[e];e++)h=!0,f.type!=Blockly.DUMMY_INPUT&&(k=
	f.connection.targetBlock(),f.type==Blockly.INPUT_VALUE?c=goog.dom.createDom("value"):f.type==Blockly.NEXT_STATEMENT&&(c=goog.dom.createDom("statement")),g=f.connection.getShadowDom(),!g||k&&k.isShadow()||c.appendChild(Blockly.Xml.cloneShadow_(g)),k&&(c.appendChild(Blockly.Xml.blockToDom(k,b)),h=!1),c.setAttribute("name",f.name),h||d.appendChild(c));a.inputsInlineDefault!=a.inputsInline&&d.setAttribute("inline",a.inputsInline);a.isCollapsed()&&d.setAttribute("collapsed",!0);a.disabled&&d.setAttribute("disabled",
	!0);a.isDeletable()||a.isShadow()||d.setAttribute("deletable",!1);a.isMovable()||a.isShadow()||d.setAttribute("movable",!1);a.isEditable()||d.setAttribute("editable",!1);if(e=a.getNextBlock())c=goog.dom.createDom("next",null,Blockly.Xml.blockToDom(e,b)),d.appendChild(c);g=a.nextConnection&&a.nextConnection.getShadowDom();!g||e&&e.isShadow()||c.appendChild(Blockly.Xml.cloneShadow_(g));return d};
	...
	*/
	...
	Blockly.WorkspaceSvg.prototype.currentGesture_=null;Blockly.WorkspaceSvg.prototype.blockDragSurface_=null;Blockly.WorkspaceSvg.prototype.workspaceDragSurface_=null;Blockly.WorkspaceSvg.prototype.useWorkspaceDragSurface_=!1;Blockly.WorkspaceSvg.prototype.isDragSurfaceActive_=!1;Blockly.WorkspaceSvg.prototype.lastRecordedPageScroll_=null;Blockly.WorkspaceSvg.prototype.injectionDiv_=null;Blockly.WorkspaceSvg.prototype.flyoutButtonCallbacks_={};
	...
	!1,h=!1,k=0;k<d.length;k++)for(var l=d[k];l;)l.isCollapsed()?g=!0:h=!0,l=l.getNextBlock();c.push(Blockly.ContextMenu.wsCollapseOption(h,d));c.push(Blockly.ContextMenu.wsExpandOption(g,d))}for(var m=Blockly.WorkspaceSvg.buildDeleteList_(d),n=0,k=0;k<m.length;k++)m[k].isShadow()||n++;d={text:1==n?Blockly.Msg.DELETE_BLOCK:Blockly.Msg.DELETE_X_BLOCKS.replace("%1",String(n)),enabled:0<n,callback:function(){f.currentGesture_&&f.currentGesture_.cancel();2>m.length?b():Blockly.confirm(Blockly.Msg.DELETE_ALL_BLOCKS.replace("%1",
	String(n)),function(a){a&&b()})}};c.push(d);Blockly.ContextMenu.show(a,c,this.RTL)}};Blockly.WorkspaceSvg.buildDeleteList_=function(a){function b(a){if(a.isDeletable())c=c.concat(a.getDescendants());else{a=a.getChildren();for(var d=0;d<a.length;d++)b(a[d])}}for(var c=[],d=0;d<a.length;d++)b(a[d]);return c};
	...
	Blockly.Extensions.register("parent_tooltip_when_inline",Blockly.Extensions.extensionParentTooltip_);Blockly.Field=function(a,b){this.size_=new goog.math.Size(Blockly.BlockSvg.FIELD_WIDTH,Blockly.BlockSvg.FIELD_HEIGHT);this.setValue(a);this.setValidator(b);this.maxDisplayLength=Blockly.BlockSvg.MAX_DISPLAY_LENGTH};Blockly.Field.cacheWidths_=null;Blockly.Field.cacheReference_=0;Blockly.Field.prototype.name=void 0;Blockly.Field.prototype.className_="blocklyText";Blockly.Field.prototype.text_="";Blockly.Field.prototype.sourceBlock_=null;Blockly.Field.prototype.visible_=!0;
	Blockly.Field.prototype.argType_=null;Blockly.Field.prototype.validator_=null;Blockly.Field.NBSP="\u00a0";Blockly.Field.prototype.EDITABLE=!0;Blockly.Field.prototype.SERIALIZABLE=!0;Blockly.Field.prototype.setSourceBlock=function(a){goog.asserts.assert(!this.sourceBlock_,"Field already bound to a block.");this.sourceBlock_=a};
	...
	Blockly.Field.stopCache=function(){Blockly.Field.cacheReference_--;Blockly.Field.cacheReference_||(Blockly.Field.cacheWidths_=null)};Blockly.Field.prototype.getSize=function(){this.size_.width||this.render_();return this.size_};Blockly.Field.prototype.getScaledBBox_=function(){var a=this.getSize(),b=a.height*this.sourceBlock_.workspace.scale,a=a.width*this.sourceBlock_.workspace.scale,c=this.getAbsoluteXY_();return{top:c.y,bottom:c.y+b,left:c.x,right:c.x+a}};
	...
	Blockly.Field.prototype.setTooltip=function(){};Blockly.Field.prototype.getClickTarget_=function(){for(var a=0,b=0,c;c=this.sourceBlock_.inputList[b];b++)a+=c.fieldRow.length;return 1>=a?this.sourceBlock_.getSvgRoot():this.getSvgRoot()};Blockly.Field.prototype.getAbsoluteXY_=function(){return goog.style.getPageOffset(this.getClickTarget_())};Blockly.FieldLabel=function(a,b){this.size_=new goog.math.Size(0,0);this.class_=b;this.setValue(a)};goog.inherits(Blockly.FieldLabel,Blockly.Field);Blockly.FieldLabel.prototype.EDITABLE=!1;Blockly.FieldLabel.prototype.SERIALIZABLE=!1;
	...
	this.render_())};Blockly.FieldLabel.prototype.dispose=function(){goog.dom.removeNode(this.textElement_);this.textElement_=null};Blockly.FieldLabel.prototype.getSvgRoot=function(){return this.textElement_};Blockly.FieldLabel.prototype.setTooltip=function(a){this.textElement_.tooltip=a};Blockly.FieldLabelSerializable=function(a,b){Blockly.FieldLabelSerializable.superClass_.constructor.call(this,a,b);this.arrowWidth_=0};goog.inherits(Blockly.FieldLabelSerializable,Blockly.FieldLabel);Blockly.FieldLabelSerializable.prototype.EDITABLE=!1;Blockly.FieldLabelSerializable.prototype.SERIALIZABLE=!0;Blockly.FieldLabelSerializable.prototype.updateWidth=function(){this.size_.width=Blockly.Field.getCachedWidth(this.textElement_)};
	Blockly.FieldLabelSerializable.prototype.render_=function(){if(this.visible_&&this.textElement_){goog.dom.removeChildren(this.textElement_);var a=document.createTextNode(this.getDisplayText_());this.textElement_.appendChild(a);this.updateWidth();var a=this.size_.width/2,b=Blockly.BlockSvg.FIELD_WIDTH/2,a=this.sourceBlock_.RTL?Math.min(this.size_.width-b,a):Math.max(b,a);this.textElement_.setAttribute("x",a)}};Blockly.FieldVariableGetter=function(a,b){Blockly.FieldVariableGetter.superClass_.constructor.call(this,a);this.name_=b};goog.inherits(Blockly.FieldVariableGetter,Blockly.Field);Blockly.FieldVariableGetter.prototype.EDITABLE=!1;Blockly.FieldVariableGetter.prototype.SERIALIZABLE=!0;
	...
	!1;this.category_=this.outputShape_=this.comment=null;this.xy_=new goog.math.Coordinate(0,0);this.workspace=a;this.isInFlyout=a.isFlyout;this.isInMutator=a.isMutator;this.RTL=a.RTL;this.isInsertionMarker_=!1;b&&(this.type=b,c=Blockly.Blocks[b],goog.asserts.assertObject(c,'Error: Unknown block type "%s".',b),goog.mixin(this,c));a.addTopBlock(this);goog.isFunction(this.init)&&this.init();this.inputsInlineDefault=this.inputsInline;Blockly.Events.isEnabled()&&Blockly.Events.fire(new Blockly.Events.BlockCreate(this));
	...
	Blockly.Block.prototype.jsonInit=function(a){var b;goog.asserts.assert(void 0==a.output||void 0==a.previousStatement,"Must not have both an output and a previousStatement.");void 0!==a.colour&&this.setColourFromJson_(a);for(b=0;void 0!==a["message"+b];)this.interpolate_(a["message"+b],a["args"+b]||[],a["lastDummyAlign"+b]),b++;void 0!==a.inputsInline&&this.setInputsInline(a.inputsInline);void 0!==a.output&&this.setOutput(!0,a.output);void 0!==a.previousStatement&&this.setPreviousStatement(!0,a.previousStatement);
	void 0!==a.nextStatement&&this.setNextStatement(!0,a.nextStatement);void 0!==a.tooltip&&(b=a.tooltip,b=Blockly.utils.replaceMessageReferences(b),this.setTooltip(b));void 0!==a.enableContextMenu&&(b=a.enableContextMenu,this.contextMenu=!!b);void 0!==a.helpUrl&&(b=a.helpUrl,b=Blockly.utils.replaceMessageReferences(b),this.setHelpUrl(b));goog.isString(a.extensions)&&(console.warn("JSON attribute 'extensions' should be an array of strings. Found raw string in JSON for '"+a.type+"' block."),a.extensions=
	[a.extensions]);void 0!==a.mutator&&Blockly.Extensions.apply(a.mutator,this,!0);if(Array.isArray(a.extensions)){var c=a.extensions;for(b=0;b<c.length;++b)Blockly.Extensions.apply(c[b],this,!1)}void 0!==a.outputShape&&this.setOutputShape(a.outputShape);void 0!==a.checkboxInFlyout&&this.setCheckboxInFlyout(a.checkboxInFlyout);void 0!==a.category&&this.setCategory(a.category)};
	...
	Blockly.BlockSvg.prototype.duplicateAndDragCallback_=function(){var a=this;return function(b){setTimeout(function(){var c=a.workspace;if(!a.getSvgRoot())throw Error("oldBlock is not rendered.");var d=Blockly.Xml.blockToDom(a);c.setResizesEnabled(!1);d=Blockly.Xml.domToBlock(d,c);Blockly.utils.changeObscuredShadowIds(d);if(!d.getSvgRoot())throw Error("newBlock is not rendered.");var e=a.getRelativeToSurfaceXY();d.moveBy(e.x,e.y);var e=e.scale(c.scale),f=c.getOriginOffsetInPixels(),e=goog.math.Coordinate.sum(f,
	e),f=c.getInjectionDiv().getBoundingClientRect();c.startDragWithFakeEvent({clientX:e.x+f.left,clientY:e.y+f.top,type:"mousedown",preventDefault:function(){b.preventDefault()},stopPropagation:function(){b.stopPropagation()},target:b.target},d)},0)}};
	...
	Blockly.BlockSvg.prototype.renderCompute_=function(){for(var a,b={statement:null,imageField:null,iconMenu:null,width:0,height:0,bayHeight:0,bayWidth:0,bayNotchAtRight:!0,fieldRadius:0,startHat:!1,endCap:!1},c=0,d;d=this.inputList[c];c++){d.type==Blockly.NEXT_STATEMENT&&(b.statement=d,b.bayHeight=Blockly.BlockSvg.MIN_BLOCK_Y,b.bayWidth=Blockly.BlockSvg.MIN_BLOCK_X,d.connection&&d.connection.targetConnection&&(a=d.connection.targetBlock(),a=a.getHeightWidth(!0),b.bayHeight=Math.max(b.bayHeight,a.height),
	b.bayWidth=Math.max(b.bayWidth,a.width)),(a=d.connection.targetBlock())&&!a.lastConnectionInStack()?b.bayNotchAtRight=!1:b.bayWidth-=Blockly.BlockSvg.NOTCH_WIDTH);a=0;for(var e;e=d.fieldRow[a];a++)e instanceof Blockly.FieldImage&&(b.imageField=e),e instanceof Blockly.FieldIconMenu&&(b.iconMenu=e),b.fieldRadius=e instanceof Blockly.FieldTextInput?e.getBorderRadius():Blockly.BlockSvg.FIELD_DEFAULT_CORNER_RADIUS}this.nextConnection&&!this.previousConnection&&(b.startHat=!0);this.nextConnection||!this.previousConnection||
	this.outputConnection||b.statement||(b.endCap=!0);b.iconMenu&&(c=b.iconMenu.getSrcForValue(b.iconMenu.getValue()))&&b.iconMenu.setParentFieldImage(c);b.width=2*Blockly.BlockSvg.SEP_SPACE_X+Blockly.BlockSvg.IMAGE_FIELD_WIDTH;b.height=2*Blockly.BlockSvg.SEP_SPACE_Y+Blockly.BlockSvg.IMAGE_FIELD_HEIGHT;this.outputConnection&&(b.height=Blockly.BlockSvg.FIELD_HEIGHT,b.width=Blockly.BlockSvg.FIELD_WIDTH);b.statement&&(b.width+=b.bayWidth+4*Blockly.BlockSvg.CORNER_RADIUS+2*Blockly.BlockSvg.GRID_UNIT,b.height=
	b.bayHeight+Blockly.BlockSvg.STATEMENT_BLOCK_SPACE);b.startHat&&(b.width+=1*Blockly.BlockSvg.GRID_UNIT);b.endCap&&(b.width+=1*Blockly.BlockSvg.GRID_UNIT);return b};
	...
	Blockly.FieldAngle.prototype.updateGraph_=function(){if(this.gauge_){var a=Number(this.getText())%360+Blockly.FieldAngle.OFFSET;var b=goog.math.toRadians(a),c=["M ",Blockly.FieldAngle.HALF,",",Blockly.FieldAngle.HALF],d=Blockly.FieldAngle.HALF,e=Blockly.FieldAngle.HALF;if(!isNaN(b)){var f=goog.math.toRadians(Blockly.FieldAngle.OFFSET),g=Math.cos(f)*Blockly.FieldAngle.RADIUS,h=Math.sin(f)*-Blockly.FieldAngle.RADIUS;Blockly.FieldAngle.CLOCKWISE&&(b=2*f-b);d+=Math.cos(b)*Blockly.FieldAngle.RADIUS;e-=
	Math.sin(b)*Blockly.FieldAngle.RADIUS;b=180<Math.abs(a-Blockly.FieldAngle.OFFSET)?1:0;f=Number(Blockly.FieldAngle.CLOCKWISE);a<Blockly.FieldAngle.OFFSET&&(f=1-f);c.push(" l ",g,",",h," A ",Blockly.FieldAngle.RADIUS,",",Blockly.FieldAngle.RADIUS," 0 ",b," ",f," ",d,",",e," z");a=Blockly.FieldAngle.CLOCKWISE?a+2*Blockly.FieldAngle.OFFSET:-a;this.arrowSvg_.setAttribute("transform","rotate("+a+")")}this.gauge_.setAttribute("d",c.join(""));this.line_.setAttribute("x2",d);this.line_.setAttribute("y2",e);
	this.handle_.setAttribute("transform","translate("+d+","+e+")")}};Blockly.FieldAngle.prototype.classValidator=function(a){if(null===a)return null;a=parseFloat(a||0);if(isNaN(a))return null;a%=360;0>a&&(a+=360);a>Blockly.FieldAngle.WRAP&&(a-=360);return String(a)};Blockly.FieldCheckbox=function(a,b){Blockly.FieldCheckbox.superClass_.constructor.call(this,"",b);this.setValue(a);this.addArgType("checkbox")};goog.inherits(Blockly.FieldCheckbox,Blockly.Field);Blockly.FieldCheckbox.CHECK_CHAR="\u2713";Blockly.FieldCheckbox.prototype.CURSOR="default";
	...
	Blockly.FieldColour.prototype.dispose=function(){Blockly.WidgetDiv.hideIfOwner(this);Blockly.FieldColour.superClass_.dispose.call(this)};Blockly.FieldColour.prototype.getValue=function(){return this.colour_};Blockly.FieldColour.prototype.setValue=function(a){this.sourceBlock_&&Blockly.Events.isEnabled()&&this.colour_!=a&&Blockly.Events.fire(new Blockly.Events.BlockChange(this.sourceBlock_,"field",this.name,this.colour_,a));this.colour_=a;this.sourceBlock_&&this.sourceBlock_.setColour(a,a,a)};
	Blockly.FieldColour.prototype.getText=function(){var a=this.colour_,b=a.match(/^#(.)\1(.)\2(.)\3$/);b&&(a="#"+b[1]+b[2]+b[3]);return a};Blockly.FieldColour.prototype.getSize=function(){return new goog.math.Size(Blockly.BlockSvg.FIELD_WIDTH,Blockly.BlockSvg.FIELD_HEIGHT)};Blockly.FieldColour.COLOURS=goog.ui.ColorPicker.SIMPLE_GRID_COLORS;Blockly.FieldColour.COLUMNS=7;Blockly.FieldColour.prototype.setColours=function(a){this.colours_=a;return this};
	...
	e.sourceBlock_&&(a=e.callValidator(a));null!==a&&e.setValue(a)})};Blockly.FieldColour.prototype.createWidget_=function(){var a=new goog.ui.ColorPicker;a.setSize(this.columns_||Blockly.FieldColour.COLUMNS);a.setColors(this.colours_||Blockly.FieldColour.COLOURS);a.render(Blockly.WidgetDiv.DIV);a.setSelectedColor(this.getValue());return a};Blockly.FieldColour.widgetDispose_=function(){Blockly.FieldColour.changeEventKey_&&goog.events.unlistenByKey(Blockly.FieldColour.changeEventKey_);Blockly.Events.setGroup(!1)};Blockly.FieldColourSlider=function(a,b){Blockly.FieldColourSlider.superClass_.constructor.call(this,a,b);this.addArgType("colour")};goog.inherits(Blockly.FieldColourSlider,Blockly.Field);Blockly.FieldColourSlider.activateEyedropper_=null;Blockly.FieldColourSlider.EYEDROPPER_PATH="eyedropper.svg";Blockly.FieldColourSlider.prototype.init=function(a){Blockly.FieldColourSlider.superClass_.init.call(this,a);this.setValue(this.getValue())};Blockly.FieldColourSlider.prototype.getValue=function(){return this.colour_};
	...
	Blockly.Generator.prototype.provideFunction_=function(a,b){if(!this.definitions_[a]){var c=this.variableDB_.getDistinctName(a,Blockly.Procedures.NAME_TYPE);this.functionNames_[a]=c;b=b.join("\n").replace(this.FUNCTION_NAME_PLACEHOLDER_REGEXP_,c);for(var d;d!=b;)d=b,b=b.replace(/^(( {2})*) {2}/gm,"$1\x00");b=b.replace(/\0/g,this.INDENT);this.definitions_[a]=b}return this.functionNames_[a]};Blockly.Generator.prototype.init=void 0;Blockly.Generator.prototype.scrub_=void 0;
	...
	d.setAttribute("type","procedures_report"),d.setAttribute("gap",16),c.push(d));c.length&&c[c.length-1].setAttribute("gap",24);a=Blockly.Procedures.allProcedures(a);b(a[0],"procedures_callnoreturn");b(a[1],"procedures_callreturn");return c};
	Blockly.Procedures.getCallers=function(a,b,c,d){for(var e=[],f=b.getTopBlocks(),g=0;g<f.length;g++)b=f[g],(b.id!=c.id||d)&&e.push.apply(e,b.getDescendants());c=[];for(g=0;g<e.length;g++)b=e[g],"procedures_callnoreturn"==b.type&&(d=b.getProcCode())&&d==a&&c.push(b);return c};
	...
	Blockly.Procedures.getDefinition=function(a,b){b=b.getTopBlocks(!1);for(var c=0;c<b.length;c++)if(b[c].getProcedureDef){var d=b[c].getProcedureDef();if(d&&Blockly.Names.equals(d[0],a))return b[c]}return null};
	Blockly.Procedures.editProcedureCallback_=function(a){if("procedures_defnoreturn"==a.type){a=a.getInput("custom_block");if(!a){alert("Bad input");return}a=a.connection;if(!a){alert("Bad connection");return}a=a.targetBlock();if(!a||"procedures_callnoreturn_internal"==!a.type){alert("Bad inner block");return}}alert('TODO(#603): implement function editing (procCode was "'+a.procCode_+'")')};Blockly.Procedures.makeEditOption=function(a){return{enabled:!0,text:Blockly.Msg.EDIT_PROCEDURE,callback:function(){Blockly.Procedures.editProcedureCallback_(a)}}};
	Blockly.Procedures.showProcedureDefCallback_=function(a){alert('TODO(#1136): implement showing procedure definition (procCode was "'+a.procCode_+'")')};Blockly.Procedures.makeShowDefinitionOption=function(a){return{enabled:!0,text:Blockly.Msg.SHOW_PROCEDURE_DEFINITION,callback:function(){Blockly.Procedures.showProcedureDefCallback_(a)}}};
	Blockly.Procedures.deleteProcedureDefCallback=function(a,b){if(0<Blockly.Procedures.getCallers(a,b.workspace,b,!1).length)return!1;Blockly.Events.setGroup(!0);b.dispose();Blockly.Events.setGroup(!1);return!0};Blockly.FlyoutButton=function(a,b,c,d){this.workspace_=a;this.targetWorkspace_=b;this.text_=c.getAttribute("text");this.position_=new goog.math.Coordinate(0,0);this.isLabel_=d;this.isCategoryLabel_="true"===c.getAttribute("category-label");this.callback_=null;a=c.getAttribute("callbackKey");this.isLabel_&&a?console.warn("Labels should not have callbacks. Label text: "+this.text_):this.isLabel_||a&&b.getButtonCallback(a)?this.callback_=b.getButtonCallback(a):console.warn("Buttons should have callbacks. Button text: "+
	this.text_);this.cssClass_=c.getAttribute("web-class")||null};Blockly.FlyoutButton.MARGIN=40;Blockly.FlyoutButton.prototype.width=0;Blockly.FlyoutButton.prototype.height=40;Blockly.FlyoutButton.prototype.onMouseUpWrapper_=null;
	...
	this.targetWorkspace_.renameVariable.bind(this.targetWorkspace_);this.workspace_.renameVariableById=this.targetWorkspace_.renameVariableById.bind(this.targetWorkspace_)};
	...
	Blockly.VerticalFlyout.prototype.position=function(){if(this.isVisible()){var a=this.targetWorkspace_.getMetrics();if(a){this.width_=this.getWidth();if(this.parentToolbox_){var b=this.parentToolbox_.getWidth()-this.width_;b=this.toolboxPosition_==Blockly.TOOLBOX_AT_RIGHT?a.viewWidth:b}else b=this.toolboxPosition_==Blockly.TOOLBOX_AT_RIGHT?a.viewWidth-this.width_:0;this.height_=Math.max(0,a.viewHeight-0);this.setBackgroundPath_(this.width_,this.height_);this.svgGroup_.setAttribute("width",this.width_);
	this.svgGroup_.setAttribute("height",this.height_);Blockly.utils.setCssTransform(this.svgGroup_,"translate("+b+"px,0px)");this.scrollbar_&&(this.scrollbar_.setOrigin(b,0),this.scrollbar_.resize());this.svgGroup_.style.opacity=1}}};
	...
	Blockly.VerticalFlyout.prototype.getClientRect=function(){if(!this.svgGroup_)return null;var a=this.svgGroup_.getBoundingClientRect(),b=a.left,a=a.width;return this.toolboxPosition_==Blockly.TOOLBOX_AT_LEFT?new goog.math.Rect(b-1E9,-1E9,1E9+a,2E9):new goog.math.Rect(b,-1E9,1E9+a,2E9)};Blockly.VerticalFlyout.prototype.reflowInternal_=function(){};Blockly.VerticalFlyout.getCheckboxState=function(){return!1};Blockly.Toolbox=function(a){this.workspace_=a;this.iconic_=!1;this.RTL=a.options.RTL;this.horizontalLayout_=a.options.horizontalLayout;this.toolboxPosition=a.options.toolboxPosition};Blockly.Toolbox.prototype.width=302;Blockly.Toolbox.prototype.height=0;Blockly.Toolbox.prototype.selectedItem_=null;
	Blockly.Toolbox.prototype.init=function(){var a=this.workspace_,b=this.workspace_.getParentSvg();this.HtmlDiv=goog.dom.createDom("DIV","blocklyToolboxDiv");this.HtmlDiv.setAttribute("dir",a.RTL?"RTL":"LTR");b.parentNode.insertBefore(this.HtmlDiv,b);Blockly.bindEventWithChecks_(this.HtmlDiv,"mousedown",this,function(a){Blockly.utils.isRightButton(a)||a.target==this.HtmlDiv?Blockly.hideChaff(!1):Blockly.hideChaff(!0);Blockly.Touch.clearTouchIdentifier()},!1,!0);this.createFlyout_();this.categoryMenu_=
	...
	Blockly.Toolbox.prototype.populate_=function(a){this.categoryMenu_.populate(a);this.showAll_();this.setSelectedItem(this.categoryMenu_.categories_[0])};Blockly.Toolbox.prototype.showAll_=function(){this.showAllForCategory_(this.categoryMenu_.categories_[0])};Blockly.Toolbox.prototype.showAllForCategory_=function(a){var b=[],c=Blockly.Xml.textToDom('<xml><label text="'+a.name_+'" category-label="true" web-class="categoryLabel"></label></xml>');b.push(c.firstChild);b=b.concat(a.getContents());this.flyout_.show(b)};
	Blockly.Toolbox.prototype.getWidth=function(){return this.width};Blockly.Toolbox.prototype.getHeight=function(){return this.categoryMenu_?this.categoryMenu_.getHeight()+3:0};
	...
	c,2E7,1E7)};Blockly.Toolbox.prototype.refreshSelection=function(){var a=this.getSelectedItem();a?this.showAllForCategory_(a):this.showAll_()};Blockly.Toolbox.prototype.getSelectedItem=function(){return this.selectedItem_};Blockly.Toolbox.prototype.setSelectedItem=function(a){this.selectedItem_&&this.selectedItem_.setSelected(!1);this.selectedItem_=a;null!=this.selectedItem_&&(this.selectedItem_.setSelected(!0),this.showAllForCategory_(a),this.flyout_.scrollToStart())};
	Blockly.Toolbox.prototype.setSelectedCategoryByName=function(a){this.selectCategoryByName(a);this.scrollToCategoryByName(a)};Blockly.Toolbox.prototype.scrollToCategoryByName=function(a){for(var b=this.flyout_.categoryScrollPositions,c=0;c<b.length;c++)if(a===b[c].categoryName){this.flyout_.setVisible(!0);this.flyout_.scrollTo(b[c].position);break}};Blockly.Toolbox.prototype.selectCategoryByName=function(a){};
	...
	Blockly.Toolbox.CategoryMenu.prototype.populate=function(a){var b;if(a){this.dispose();this.createDom();for(var c=[],d=0;b=a.childNodes[d];d++)b.tagName&&"CATEGORY"==b.tagName.toUpperCase()&&c.push(b);for(d=0;d<c.length;d++)b=c[d],a=goog.dom.createDom("div","scratchCategoryMenuRow"),this.table.appendChild(a),b&&this.categories_.push(new Blockly.Toolbox.Category(this,a,b));this.height_=this.table.offsetHeight}};
	...
	Blockly.Css.inject=function(a,b){if(!Blockly.Css.styleSheet_){var c=".blocklyDraggable {}\n";a&&(c+=Blockly.Css.CONTENT.join("\n"),Blockly.FieldDate&&(c+=Blockly.FieldDate.CSS.join("\n")));Blockly.Css.mediaPath_=b.replace(/[\\\/]$/,"");var c=c.replace(/<<<PATH>>>/g,Blockly.Css.mediaPath_),d;for(d in Blockly.Colours)Blockly.Colours.hasOwnProperty(d)&&(c=c.replace(new RegExp("\\$colour\\_"+d,"g"),Blockly.Colours[d]));a=document.createElement("style");document.head.insertBefore(a,document.head.firstChild);
	...
	"padding: 2px;","position: absolute;","z-index: 100000;","}",".blocklyDropDownDiv {","position: fixed;","left: 0;","top: 0;","z-index: 1000;","display: none;","border: 1px solid;","border-radius: 4px;","box-shadow: 0px 0px 8px 1px "+Blockly.Colours.dropDownShadow+";","padding: 4px;","-webkit-user-select: none;","}",".blocklyDropDownContent {","max-height: 300px;","overflow: auto;","}",".blocklyDropDownArrow {","position: absolute;","left: 0;","top: 0;","width: 16px;","height: 16px;","z-index: -1;",
	...
	"}",".blocklyTreeRow {","height: 22px;","line-height: 22px;","margin-bottom: 3px;","padding-right: 8px;","white-space: nowrap;","}",".blocklyHorizontalTree {","float: left;","margin: 1px 5px 8px 0;","}",".blocklyHorizontalTreeRtl {","float: right;","margin: 1px 0 8px 5px;","}",'.blocklyToolboxDiv[dir="RTL"] .blocklyTreeRow {',"margin-left: 8px;","}",".blocklyTreeRow:not(.blocklyTreeSelected):hover {","background-color: #e4e4e4;","}",".blocklyTreeSeparator {","border-bottom: solid #e5e5e5 1px;","height: 0;",
	...
	"-moz-box-shadow: 0 0 0 4px rgba(0, 0, 0, 0.15);","box-shadow: 0 0 0 4px rgba(0, 0, 0, 0.15);","}",".scratchEyedropper {","background: none;","outline: none;","border: none;","width: 100%;","text-align: center;","border-top: 1px solid #ddd;","padding-top: 5px;","cursor: pointer;","}",".scratchColourPickerLabel {",'font-family: "Helvetica Neue", Helvetica, sans-serif;',"font-size: 0.65rem;","color: $colour_toolboxText;","margin: 8px;","}",".scratchColourPickerLabelText {","font-weight: bold;","}",
	".scratchColourPickerReadout {","margin-left: 10px;","}",".blocklyWidgetDiv .goog-menu {","background: #fff;","border-color: #ccc #666 #666 #ccc;","border-style: solid;","border-width: 1px;","cursor: default;",'font: normal 13px "Helvetica Neue", Helvetica, sans-serif;',"margin: 0;","outline: none;","padding: 4px 0;","position: absolute;","overflow-y: auto;","overflow-x: hidden;","z-index: 20000;","}",".blocklyDropDownDiv .goog-menu {","cursor: default;",'font: normal 13px "Helvetica Neue", Helvetica, sans-serif;',
	"outline: none;","z-index: 20000;","}",".blocklyWidgetDiv .goog-menuitem {","color: #000;",'font: normal 13px "Helvetica Neue", Helvetica, sans-serif;',"list-style: none;","margin: 0;","padding: 4px 7em 4px 28px;","white-space: nowrap;","}",".blocklyDropDownDiv .goog-menuitem {","color: #fff;",'font: normal 13px "Helvetica Neue", Helvetica, sans-serif;',"font-weight: bold;","list-style: none;","margin: 0;","padding: 4px 7em 4px 28px;","white-space: nowrap;","}",".blocklyWidgetDiv .goog-menuitem.goog-menuitem-rtl, ",
	...
	return b};
	Blockly.createDom_=function(a,b){a.setAttribute("dir","LTR");goog.ui.Component.setDefaultRightToLeft(b.RTL);Blockly.Css.inject(b.hasCss,b.pathToMedia);a=Blockly.utils.createSvgElement("svg",{xmlns:"http://www.w3.org/2000/svg","xmlns:html":"http://www.w3.org/1999/xhtml","xmlns:xlink":"http://www.w3.org/1999/xlink",version:"1.1","class":"blocklySvg"},a);var c=Blockly.utils.createSvgElement("defs",{},a),d=String(Math.random()).substring(2),e=Blockly.utils.createSvgElement("filter",{id:"blocklyStackGlowFilter",height:"160%",
	width:"180%",y:"-30%",x:"-40%"},c);b.stackGlowBlur=Blockly.utils.createSvgElement("feGaussianBlur",{"in":"SourceGraphic",stdDeviation:Blockly.STACK_GLOW_RADIUS},e);var f=Blockly.utils.createSvgElement("feComponentTransfer",{result:"outBlur"},e);Blockly.utils.createSvgElement("feFuncA",{type:"table",tableValues:"0"+goog.string.repeat(" 1",16)},f);Blockly.utils.createSvgElement("feFlood",{"flood-color":Blockly.Colours.stackGlow,"flood-opacity":Blockly.Colours.stackGlowOpacity,result:"outColor"},e);
	Blockly.utils.createSvgElement("feComposite",{"in":"outColor",in2:"outBlur",operator:"in",result:"outGlow"},e);Blockly.utils.createSvgElement("feComposite",{"in":"SourceGraphic",in2:"outGlow",operator:"over"},e);e=Blockly.utils.createSvgElement("filter",{id:"blocklyReplacementGlowFilter",height:"160%",width:"180%",y:"-30%",x:"-40%"},c);Blockly.utils.createSvgElement("feGaussianBlur",{"in":"SourceGraphic",stdDeviation:Blockly.REPLACEMENT_GLOW_RADIUS},e);f=Blockly.utils.createSvgElement("feComponentTransfer",
	{result:"outBlur"},e);Blockly.utils.createSvgElement("feFuncA",{type:"table",tableValues:"0"+goog.string.repeat(" 1",16)},f);Blockly.utils.createSvgElement("feFlood",{"flood-color":Blockly.Colours.replacementGlow,"flood-opacity":Blockly.Colours.replacementGlowOpacity,result:"outColor"},e);Blockly.utils.createSvgElement("feComposite",{"in":"outColor",in2:"outBlur",operator:"in",result:"outGlow"},e);Blockly.utils.createSvgElement("feComposite",{"in":"SourceGraphic",in2:"outGlow",operator:"over"},e);
	f=Blockly.utils.createSvgElement("pattern",{id:"blocklyDisabledPattern"+d,patternUnits:"userSpaceOnUse",width:10,height:10},c);Blockly.utils.createSvgElement("rect",{width:10,height:10,fill:"#aaa"},f);Blockly.utils.createSvgElement("path",{d:"M 0 0 L 10 10 M 10 0 L 0 10",stroke:"#cc0"},f);b.disabledPatternId=f.id;b.gridPattern=Blockly.Grid.createDom(d,b.gridOptions,c);return a};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(7).goog;
